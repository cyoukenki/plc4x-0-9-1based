...
[discriminatedType 'McPacket'
    [discriminator        uint 16 'Subheader']//请求副帧头//0x5000
    [simple        uint 16 'RequestdestinationnetworkNo']//请求目标网络No.//0x00
    [simple        uint 16 'RequestdestinationstationNo']//请求目标站号No.//0xFF
    [simple        uint 32 'RequestdestinationmoduleIONo']//请求目标模块I/O编号No  //0xFF03
    ...
    [typeSwitch 'Subheader'
        ['0x35303030' McRequest		//请求副帧头（Subheader） "5000",占用4字节
            ...
            [simple        uint 32 'Monitoringtimer']		//监视定时器，占用4字节//0x0000
