...
[dataIo 'DataItem' [string '-1' 'dataProtocolId', int 32 'stringLength']
    [typeSwitch 'dataProtocolId'
        ...
        ['IEC61131_STRING' STRING
            [manual string '-1' 'UTF-8' 'value'  'STATIC_CALL("org.apache.plc4x.java.s7.utils.StaticHelper.parseS7String", readBuffer, stringLength, _type.encoding)' 'STATIC_CALL("org.apache.plc4x.java.s7.utils.StaticHelper.serializeS7String", writeBuffer, _value, stringLength, _type.encoding)' '(STR_LEN(_value.string) + 2) * 8']
        ]
