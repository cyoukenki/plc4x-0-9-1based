...
[enum uint 16 'KnxManufacturer' [uint 16 'number', string '-1' 'name']
    ...
    ['704' M_ABB___RESERVED ['43954', '"ABB - reserved"']]
    ['705' M_BUSCH_JAEGER_ELEKTRO___RESERVED ['43959', '"Busch-Jaeger Elektro - reserved"']]
...
[dataIo 'KnxDatapoint' [KnxDatapointType 'datapointType']
    [typeSwitch 'datapointType'
        ...
        ['DPT_TempRoomSetpSetF16_3' Struct                    
                    [simple float 4.11 'tempsetpcomf']
                                    
                    [simple float 4.11 'tempsetpstdby']
                                    
                    [simple float 4.11 'tempsetpeco']
                
        ]
    
        ['DPT_TempRoomSetpSetShiftF16_3' Struct                    
                    [simple float 4.11 'tempsetpshiftcomf']
                                    
                    [simple float 4.11 'tempsetpshiftstdby']
                                    
                    [simple float 4.11 'tempsetpshifteco']
        ...
        ['DPT_GeographicalLocation' Struct                    
                    [simple float 8.23 'longitude']
                                    
                    [simple float 8.23 'latitude']
                
        ]
    
        ['DPT_TempRoomSetpSetF16_4' Struct                    
                    [simple float 4.11 'roomTemperatureSetpointComfort']
                                    
                    [simple float 4.11 'roomTemperatureSetpointStandby']
                                    
                    [simple float 4.11 'roomTemperatureSetpointEconomy']
                                    
                    [simple float 4.11 'roomTemperatureSetpointBuildingProtection']
                
        ]
    
        ['DPT_TempRoomSetpSetShiftF16_4' Struct                    
                    [simple float 4.11 'roomTemperatureSetpointShiftComfort']
                                    
                    [simple float 4.11 'roomTemperatureSetpointShiftStandby']
                                    
                    [simple float 4.11 'roomTemperatureSetpointShiftEconomy']
                                    
                    [simple float 4.11 'roomTemperatureSetpointShiftBuildingProtection']
