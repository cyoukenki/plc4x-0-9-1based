...
public interface PlcDriver {
    ...
    default PlcServerConnector getServerConnector(String url) throws PlcConnectionException {
    ...
    default void setListener(MessageExchangeListener messageExchangeListener){
        throw new PlcNotImplementedException("Not implemented for " + getProtocolName());
    }
}
