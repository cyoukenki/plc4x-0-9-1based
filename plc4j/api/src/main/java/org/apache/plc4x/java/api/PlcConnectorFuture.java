...
public interface PlcConnectorFuture {
     ...
     */
    void setMessageExchangeListener(MessageExchangeListener connectorListener);

    MessageExchangeListener getMessageExchangeListener();
