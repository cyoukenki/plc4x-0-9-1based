...
import org.apache.plc4x.java.api.internal.DataHolder;
...
public class PlcDriverManager {
    ...
    public PlcServerConnector getServerConnector(String url) throws PlcConnectionException {
        PlcDriver driver = getDriverForUrl(url);
        PlcServerConnector serverConnector = driver.getServerConnector(url);
    ...
    public PlcServerConnector getServerConnector(String url, PlcAuthentication authentication) throws PlcConnectionException {
        PlcDriver driver = getDriverForUrl(url);
        PlcServerConnector serverConnector = driver.getServerConnector(url);
