...
public class PooledPlcDriverManager extends PlcDriverManager {
    ...
    public PlcConnection getConnection(String url, PlcAuthentication authentication) throws PlcConnectionException {
        // LOGGER.info("pkpkpkpkppkpkpkpkpk:before poolKey");
        PoolKey poolKey = poolKeyFactory.getPoolKey(url, authentication);
        // LOGGER.info("pkpkpkpkppkpkpkpkpk:after poolKey");
        ...
        try {
            // LOGGER.info("BBBBBBBBBBBBB:before borrow object");
            plcConnection = keyedObjectPool.borrowObject(poolKey);
            // LOGGER.info("BBBBBBBBBBBBB:after borrow object");
            if (plcConnection.isConnected() == false) {
                LOGGER.debug("Attempting to reconnect to device");
                // LOGGER.info("CCCCCCCCCCCCCCC:before connect");
                plcConnection.connect();
                // LOGGER.info("CCCCCCCCCCCCCCCC:after connect");
            }
        } catch (Exception e) {
