 ...
 * under the License.
 */
package org.apache.plc4x.java.ckd.readwrite.field;
 ...
 */
public class CkdField implements PlcField {
    ...
    private CkdField(String name, int numElements) {
        this.name = name;
        this.numElements = numElements;
    }

    public static CkdField of(String fieldString) throws PlcInvalidFieldException {
        ...
        if (matcher.matches()) {
            ...
            return new CkdField(name, numElements);
        }
