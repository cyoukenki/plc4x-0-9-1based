...
public class HistoryReadResultIO implements MessageIO<HistoryReadResult, HistoryReadResult> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HistoryReadResultIO.class);

    @Override
    public HistoryReadResult parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (HistoryReadResult) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, HistoryReadResult value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static HistoryReadResultBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
ExtensionObject historyData = ExtensionObjectIO.staticParse(readBuffer , (boolean) (true) ) ;        readBuffer.closeContext("historyData");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, HistoryReadResult _value) throws ParseException {
        ...
        // Simple Field (historyData)
        ExtensionObject historyData = (ExtensionObject) _value.getHistoryData();
        writeBuffer.pushContext("historyData");
        ExtensionObjectIO.staticSerialize(writeBuffer, historyData);
        writeBuffer.popContext("historyData");
        writeBuffer.popContext("HistoryReadResult");
    }

    public static class HistoryReadResultBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
