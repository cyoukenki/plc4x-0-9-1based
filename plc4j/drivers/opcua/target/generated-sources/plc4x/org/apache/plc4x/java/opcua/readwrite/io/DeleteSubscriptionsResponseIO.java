...
public class DeleteSubscriptionsResponseIO implements MessageIO<DeleteSubscriptionsResponse, DeleteSubscriptionsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteSubscriptionsResponseIO.class);

    @Override
    public DeleteSubscriptionsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (DeleteSubscriptionsResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, DeleteSubscriptionsResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static DeleteSubscriptionsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new DeleteSubscriptionsResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, DeleteSubscriptionsResponse _value) throws ParseException {
    ...
    public static class DeleteSubscriptionsResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public DeleteSubscriptionsResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public DeleteSubscriptionsResponse build() {
            return new DeleteSubscriptionsResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
