...
public class GetEndpointsResponse extends ExtensionObjectDefinition implements Message {
    ...
    public GetEndpointsResponse(ExtensionObjectDefinition responseHeader, int noOfEndpoints, ExtensionObjectDefinition[] endpoints) {
    ...
    public ExtensionObjectDefinition[] getEndpoints() {
        return endpoints;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(endpoints != null) {
            ...
            for(ExtensionObjectDefinition element : endpoints) {
                boolean last = ++i >= endpoints.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfEndpoints", getNoOfEndpoints())
            .append("endpoints", getEndpoints())
            .toString();
    }
