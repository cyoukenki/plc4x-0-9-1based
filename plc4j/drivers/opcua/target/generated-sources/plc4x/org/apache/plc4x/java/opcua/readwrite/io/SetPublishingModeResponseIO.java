...
public class SetPublishingModeResponseIO implements MessageIO<SetPublishingModeResponse, SetPublishingModeResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SetPublishingModeResponseIO.class);

    @Override
    public SetPublishingModeResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SetPublishingModeResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SetPublishingModeResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static SetPublishingModeResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new SetPublishingModeResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, SetPublishingModeResponse _value) throws ParseException {
    ...
    public static class SetPublishingModeResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public SetPublishingModeResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public SetPublishingModeResponse build() {
            return new SetPublishingModeResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
