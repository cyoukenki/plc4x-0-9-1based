...
public class RegisterNodesResponse extends ExtensionObjectDefinition implements Message {
    ...
    public RegisterNodesResponse(ExtensionObjectDefinition responseHeader, int noOfRegisteredNodeIds, NodeId[] registeredNodeIds) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(registeredNodeIds != null) {
            ...
            for(NodeId element : registeredNodeIds) {
                boolean last = ++i >= registeredNodeIds.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfRegisteredNodeIds", getNoOfRegisteredNodeIds())
            .append("registeredNodeIds", getRegisteredNodeIds())
            .toString();
    }
