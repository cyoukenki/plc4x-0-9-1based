...
public class DeleteReferencesResponseIO implements MessageIO<DeleteReferencesResponse, DeleteReferencesResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteReferencesResponseIO.class);

    @Override
    public DeleteReferencesResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (DeleteReferencesResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, DeleteReferencesResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static DeleteReferencesResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new DeleteReferencesResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, DeleteReferencesResponse _value) throws ParseException {
    ...
    public static class DeleteReferencesResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public DeleteReferencesResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public DeleteReferencesResponse build() {
            return new DeleteReferencesResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
