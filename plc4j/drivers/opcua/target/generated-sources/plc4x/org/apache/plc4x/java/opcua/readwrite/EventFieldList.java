...
public class EventFieldList extends ExtensionObjectDefinition implements Message {
    ...
    public EventFieldList(long clientHandle, int noOfEventFields, Variant[] eventFields) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(eventFields != null) {
            ...
            for(Variant element : eventFields) {
                boolean last = ++i >= eventFields.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfEventFields", getNoOfEventFields())
            .append("eventFields", getEventFields())
            .toString();
    }
