...
public class AddReferencesResponse extends ExtensionObjectDefinition implements Message {
    ...
    public AddReferencesResponse(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        AddReferencesResponse _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddReferencesResponse)) {
            return false;
        }
