...
public class CreateMonitoredItemsResponseIO implements MessageIO<CreateMonitoredItemsResponse, CreateMonitoredItemsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateMonitoredItemsResponseIO.class);

    @Override
    public CreateMonitoredItemsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (CreateMonitoredItemsResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, CreateMonitoredItemsResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static CreateMonitoredItemsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        readBuffer.pullContext("CreateMonitoredItemsResponse");
...
int noOfResults = readBuffer.readInt("noOfResults", 32) ;        // Array field (results)
        ...
        ExtensionObjectDefinition[] results;
        {
            int itemCount = Math.max(0, (int) noOfResults);
            results = new ExtensionObjectDefinition[itemCount];
            for(int curItem = 0; curItem < itemCount; curItem++) {
                boolean lastItem = curItem == (itemCount - 1);
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(748) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("CreateMonitoredItemsResponse");
        // Create the instance
        return new CreateMonitoredItemsResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, CreateMonitoredItemsResponse _value) throws ParseException {
        ...
        if(_value.getResults() != null) {
            ...
            int curItem = 0;
            for(ExtensionObjectDefinition element : _value.getResults()) {
                boolean lastItem = curItem == (itemCount - 1);
        ...
        writeBuffer.popContext("CreateMonitoredItemsResponse");
    }

    public static class CreateMonitoredItemsResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public CreateMonitoredItemsResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public CreateMonitoredItemsResponse build() {
            return new CreateMonitoredItemsResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
