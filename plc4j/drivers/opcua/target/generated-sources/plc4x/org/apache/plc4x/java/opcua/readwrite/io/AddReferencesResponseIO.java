...
public class AddReferencesResponseIO implements MessageIO<AddReferencesResponse, AddReferencesResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddReferencesResponseIO.class);

    @Override
    public AddReferencesResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (AddReferencesResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, AddReferencesResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static AddReferencesResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new AddReferencesResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, AddReferencesResponse _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("AddReferencesResponse");
        ...
        writeBuffer.popContext("AddReferencesResponse");
    }

    public static class AddReferencesResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public AddReferencesResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public AddReferencesResponse build() {
            return new AddReferencesResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
