...
public class PublishResponseIO implements MessageIO<PublishResponse, PublishResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PublishResponseIO.class);

    @Override
    public PublishResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (PublishResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, PublishResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static PublishResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
boolean moreNotifications = readBuffer.readBit("moreNotifications") ;
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new PublishResponseBuilder(responseHeader, subscriptionId, noOfAvailableSequenceNumbers, availableSequenceNumbers, moreNotifications, notificationMessage, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, PublishResponse _value) throws ParseException {
        ...
        // Simple Field (moreNotifications)
        boolean moreNotifications = (boolean) _value.getMoreNotifications();
        writeBuffer.writeBit("moreNotifications", (boolean) (moreNotifications));
    ...
    public static class PublishResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public PublishResponseBuilder(ExtensionObjectDefinition responseHeader, long subscriptionId, int noOfAvailableSequenceNumbers, long[] availableSequenceNumbers, boolean moreNotifications, ExtensionObjectDefinition notificationMessage, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public PublishResponse build() {
            return new PublishResponse(responseHeader, subscriptionId, noOfAvailableSequenceNumbers, availableSequenceNumbers, moreNotifications, notificationMessage, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
