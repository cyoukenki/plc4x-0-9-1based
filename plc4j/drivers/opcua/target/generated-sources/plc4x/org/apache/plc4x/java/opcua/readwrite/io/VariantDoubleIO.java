...
public class VariantDoubleIO implements MessageIO<VariantDouble, VariantDouble> {

    private static final Logger LOGGER = LoggerFactory.getLogger(VariantDoubleIO.class);

    @Override
    public VariantDouble parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (VariantDouble) new VariantIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, VariantDouble value, Object... args) throws ParseException {
        new VariantIO().serialize(writeBuffer, value, args);
    }

    public static VariantDoubleBuilder staticParse(ReadBuffer readBuffer, Boolean arrayLengthSpecified) throws ParseException {
        ...
        double[] value;
        {
            ...
            value = new double[itemCount];
            for(int curItem = 0; curItem < itemCount; curItem++) {
                
value[curItem] = ((Supplier<Double>) (() -> { return (double) toFloat(readBuffer, "", true, 11, 52); })).get() ;            }
        }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, VariantDouble _value) throws ParseException {
        ...
        if(_value.getValue() != null) {
            ...
            int curItem = 0;
            for(double element : _value.getValue()) {
    ...
    public static class VariantDoubleBuilder implements VariantIO.VariantBuilder {
        private final Integer arrayLength;
        private final double[] value;

        public VariantDoubleBuilder(Integer arrayLength, double[] value) {
            this.arrayLength = arrayLength;
            this.value = value;
        }

        public VariantDouble build(boolean arrayLengthSpecified, boolean arrayDimensionsSpecified, Integer noOfArrayDimensions, boolean[] arrayDimensions) {
