...
public class AddReferencesRequest extends ExtensionObjectDefinition implements Message {
    ...
    public AddReferencesRequest(ExtensionObjectDefinition requestHeader, int noOfReferencesToAdd, ExtensionObjectDefinition[] referencesToAdd) {
    ...
    public ExtensionObjectDefinition[] getReferencesToAdd() {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(referencesToAdd != null) {
            ...
            for(ExtensionObjectDefinition element : referencesToAdd) {
                boolean last = ++i >= referencesToAdd.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfReferencesToAdd", getNoOfReferencesToAdd())
            .append("referencesToAdd", getReferencesToAdd())
            .toString();
    }
