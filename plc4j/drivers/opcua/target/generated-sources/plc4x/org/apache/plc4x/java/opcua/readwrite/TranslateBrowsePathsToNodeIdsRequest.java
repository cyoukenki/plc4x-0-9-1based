...
public class TranslateBrowsePathsToNodeIdsRequest extends ExtensionObjectDefinition implements Message {
    ...
    public TranslateBrowsePathsToNodeIdsRequest(ExtensionObjectDefinition requestHeader, int noOfBrowsePaths, ExtensionObjectDefinition[] browsePaths) {
    ...
    public ExtensionObjectDefinition[] getBrowsePaths() {
        return browsePaths;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(browsePaths != null) {
            ...
            for(ExtensionObjectDefinition element : browsePaths) {
                boolean last = ++i >= browsePaths.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfBrowsePaths", getNoOfBrowsePaths())
            .append("browsePaths", getBrowsePaths())
            .toString();
    }
