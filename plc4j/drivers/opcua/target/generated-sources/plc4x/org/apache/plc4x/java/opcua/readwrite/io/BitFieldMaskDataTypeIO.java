...
public class BitFieldMaskDataTypeIO implements MessageIO<BitFieldMaskDataType, BitFieldMaskDataType> {
    ...
    @Override
    public BitFieldMaskDataType parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return BitFieldMaskDataTypeIO.staticParse(readBuffer);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, BitFieldMaskDataType value, Object... args) throws ParseException {
        BitFieldMaskDataTypeIO.staticSerialize(writeBuffer, value);
    }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, BitFieldMaskDataType _value) throws ParseException {
