...
public class SetMonitoringModeResponseIO implements MessageIO<SetMonitoringModeResponse, SetMonitoringModeResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SetMonitoringModeResponseIO.class);

    @Override
    public SetMonitoringModeResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SetMonitoringModeResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SetMonitoringModeResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static SetMonitoringModeResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new SetMonitoringModeResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, SetMonitoringModeResponse _value) throws ParseException {
    ...
    public static class SetMonitoringModeResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public SetMonitoringModeResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public SetMonitoringModeResponse build() {
            return new SetMonitoringModeResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
