...
public class BrowseNextRequest extends ExtensionObjectDefinition implements Message {
    ...
    public BrowseNextRequest(ExtensionObjectDefinition requestHeader, boolean releaseContinuationPoints, int noOfContinuationPoints, PascalByteString[] continuationPoints) {
    ...
    public PascalByteString[] getContinuationPoints() {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(continuationPoints != null) {
            ...
            for(PascalByteString element : continuationPoints) {
                boolean last = ++i >= continuationPoints.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfContinuationPoints", getNoOfContinuationPoints())
            .append("continuationPoints", getContinuationPoints())
            .toString();
    }
