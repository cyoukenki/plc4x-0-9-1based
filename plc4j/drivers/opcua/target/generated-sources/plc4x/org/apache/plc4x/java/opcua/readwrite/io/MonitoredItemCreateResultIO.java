...
public class MonitoredItemCreateResultIO implements MessageIO<MonitoredItemCreateResult, MonitoredItemCreateResult> {
    ...
    @Override
    public MonitoredItemCreateResult parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (MonitoredItemCreateResult) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, MonitoredItemCreateResult value, Object... args) throws ParseException {
...
ExtensionObject filterResult = ExtensionObjectIO.staticParse(readBuffer , (boolean) (true) ) ;        readBuffer.closeContext("filterResult");
        ...
        // Create the instance
        return new MonitoredItemCreateResultBuilder(statusCode, monitoredItemId, revisedSamplingInterval, revisedQueueSize, filterResult);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, MonitoredItemCreateResult _value) throws ParseException {
    ...
    public static class MonitoredItemCreateResultBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public MonitoredItemCreateResultBuilder(StatusCode statusCode, long monitoredItemId, double revisedSamplingInterval, long revisedQueueSize, ExtensionObject filterResult) {
