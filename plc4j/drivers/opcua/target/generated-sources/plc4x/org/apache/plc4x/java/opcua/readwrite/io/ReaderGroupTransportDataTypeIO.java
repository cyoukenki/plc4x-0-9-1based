...
public class ReaderGroupTransportDataTypeIO implements MessageIO<ReaderGroupTransportDataType, ReaderGroupTransportDataType> {
    ...
    @Override
    public ReaderGroupTransportDataType parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ReaderGroupTransportDataType) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ReaderGroupTransportDataType value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ReaderGroupTransportDataType _value) throws ParseException {
