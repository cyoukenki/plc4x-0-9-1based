...
public class TransferSubscriptionsResponseIO implements MessageIO<TransferSubscriptionsResponse, TransferSubscriptionsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(TransferSubscriptionsResponseIO.class);

    @Override
    public TransferSubscriptionsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (TransferSubscriptionsResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, TransferSubscriptionsResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static TransferSubscriptionsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(838) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new TransferSubscriptionsResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, TransferSubscriptionsResponse _value) throws ParseException {
    ...
    public static class TransferSubscriptionsResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public TransferSubscriptionsResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public TransferSubscriptionsResponse build() {
            return new TransferSubscriptionsResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
