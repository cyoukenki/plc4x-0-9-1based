...
public class VariantUInt32IO implements MessageIO<VariantUInt32, VariantUInt32> {
    ...
    @Override
    public VariantUInt32 parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (VariantUInt32) new VariantIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, VariantUInt32 value, Object... args) throws ParseException {
        new VariantIO().serialize(writeBuffer, value, args);
    }

    public static VariantUInt32Builder staticParse(ReadBuffer readBuffer, Boolean arrayLengthSpecified) throws ParseException {
...
value[curItem] = readBuffer.readUnsignedLong("", 32) ;            }
        }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, VariantUInt32 _value) throws ParseException {
    ...
    public static class VariantUInt32Builder implements VariantIO.VariantBuilder {
        ...
        public VariantUInt32Builder(Integer arrayLength, long[] value) {
            this.arrayLength = arrayLength;
            this.value = value;
        }

        public VariantUInt32 build(boolean arrayLengthSpecified, boolean arrayDimensionsSpecified, Integer noOfArrayDimensions, boolean[] arrayDimensions) {
