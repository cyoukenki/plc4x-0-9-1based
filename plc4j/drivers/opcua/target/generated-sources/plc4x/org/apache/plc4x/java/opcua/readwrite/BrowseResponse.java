...
public class BrowseResponse extends ExtensionObjectDefinition implements Message {
    ...
    public BrowseResponse(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BrowseResponse)) {
            return false;
        }
        BrowseResponse that = (BrowseResponse) o;
        return
