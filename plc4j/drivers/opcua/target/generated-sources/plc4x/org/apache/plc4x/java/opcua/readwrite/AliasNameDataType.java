...
public class AliasNameDataType extends ExtensionObjectDefinition implements Message {
    ...
    public AliasNameDataType(QualifiedName aliasName, int noOfReferencedNodes, ExpandedNodeId[] referencedNodes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(referencedNodes != null) {
            ...
            for(ExpandedNodeId element : referencedNodes) {
                boolean last = ++i >= referencedNodes.length;
    ...
    public boolean equals(Object o) {
        ...
        return
            (getAliasName() == that.getAliasName()) &&
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfReferencedNodes", getNoOfReferencedNodes())
            .append("referencedNodes", getReferencedNodes())
            .toString();
    }
