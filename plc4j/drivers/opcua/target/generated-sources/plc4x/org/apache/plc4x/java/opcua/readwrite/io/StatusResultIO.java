...
public class StatusResultIO implements MessageIO<StatusResult, StatusResult> {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatusResultIO.class);

    @Override
    public StatusResult parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (StatusResult) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, StatusResult value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static StatusResultBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
DiagnosticInfo diagnosticInfo = DiagnosticInfoIO.staticParse(readBuffer ) ;        readBuffer.closeContext("diagnosticInfo");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, StatusResult _value) throws ParseException {
    ...
    public static class StatusResultBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
