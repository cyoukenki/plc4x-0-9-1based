...
public class WriteRequest extends ExtensionObjectDefinition implements Message {
    ...
    public WriteRequest(ExtensionObjectDefinition requestHeader, int noOfNodesToWrite, ExtensionObjectDefinition[] nodesToWrite) {
    ...
    public ExtensionObjectDefinition[] getNodesToWrite() {
        return nodesToWrite;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(nodesToWrite != null) {
            ...
            for(ExtensionObjectDefinition element : nodesToWrite) {
                boolean last = ++i >= nodesToWrite.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfNodesToWrite", getNoOfNodesToWrite())
            .append("nodesToWrite", getNodesToWrite())
            .toString();
    }
