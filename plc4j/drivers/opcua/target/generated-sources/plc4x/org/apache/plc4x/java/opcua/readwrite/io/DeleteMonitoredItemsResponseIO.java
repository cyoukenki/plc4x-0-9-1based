...
public class DeleteMonitoredItemsResponseIO implements MessageIO<DeleteMonitoredItemsResponse, DeleteMonitoredItemsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteMonitoredItemsResponseIO.class);

    @Override
    public DeleteMonitoredItemsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (DeleteMonitoredItemsResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, DeleteMonitoredItemsResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static DeleteMonitoredItemsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new DeleteMonitoredItemsResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, DeleteMonitoredItemsResponse _value) throws ParseException {
    ...
    public static class DeleteMonitoredItemsResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public DeleteMonitoredItemsResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public DeleteMonitoredItemsResponse build() {
            return new DeleteMonitoredItemsResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
