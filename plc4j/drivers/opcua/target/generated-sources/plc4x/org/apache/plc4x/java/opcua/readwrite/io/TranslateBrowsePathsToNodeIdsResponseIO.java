...
public class TranslateBrowsePathsToNodeIdsResponseIO implements MessageIO<TranslateBrowsePathsToNodeIdsResponse, TranslateBrowsePathsToNodeIdsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(TranslateBrowsePathsToNodeIdsResponseIO.class);

    @Override
    public TranslateBrowsePathsToNodeIdsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (TranslateBrowsePathsToNodeIdsResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, TranslateBrowsePathsToNodeIdsResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static TranslateBrowsePathsToNodeIdsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(551) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new TranslateBrowsePathsToNodeIdsResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, TranslateBrowsePathsToNodeIdsResponse _value) throws ParseException {
        ...
        writeBuffer.popContext("TranslateBrowsePathsToNodeIdsResponse");
    }

    public static class TranslateBrowsePathsToNodeIdsResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public TranslateBrowsePathsToNodeIdsResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public TranslateBrowsePathsToNodeIdsResponse build() {
            return new TranslateBrowsePathsToNodeIdsResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
