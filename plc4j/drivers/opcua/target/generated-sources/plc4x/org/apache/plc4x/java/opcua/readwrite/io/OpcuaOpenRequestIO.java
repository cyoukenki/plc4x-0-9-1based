...
public class OpcuaOpenRequestIO implements MessageIO<OpcuaOpenRequest, OpcuaOpenRequest> {
    ...
    @Override
    public OpcuaOpenRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (OpcuaOpenRequest) new MessagePDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, OpcuaOpenRequest value, Object... args) throws ParseException {
...
int requestId = readBuffer.readInt("requestId", 32) ;        // Array field (message)
        ...
        // Count array
        if(((((messageSize) - (((((endpoint.getStringLength()) == (-(1))) ? 0 : endpoint.getStringLength())))) - (((((senderCertificate.getStringLength()) == (-(1))) ? 0 : senderCertificate.getStringLength())))) - (((((receiverCertificateThumbprint.getStringLength()) == (-(1))) ? 0 : receiverCertificateThumbprint.getStringLength())))) - (32) > Integer.MAX_VALUE) {
            throw new ParseException("Array count of " + (((((messageSize) - (((((endpoint.getStringLength()) == (-(1))) ? 0 : endpoint.getStringLength())))) - (((((senderCertificate.getStringLength()) == (-(1))) ? 0 : senderCertificate.getStringLength())))) - (((((receiverCertificateThumbprint.getStringLength()) == (-(1))) ? 0 : receiverCertificateThumbprint.getStringLength())))) - (32)) + " exceeds the maximum allowed count of " + Integer.MAX_VALUE);
        }
        byte[] message;
        {
            int itemCount = Math.max(0, (int) ((((messageSize) - (((((endpoint.getStringLength()) == (-(1))) ? 0 : endpoint.getStringLength())))) - (((((senderCertificate.getStringLength()) == (-(1))) ? 0 : senderCertificate.getStringLength())))) - (((((receiverCertificateThumbprint.getStringLength()) == (-(1))) ? 0 : receiverCertificateThumbprint.getStringLength())))) - (32));
...
message[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, OpcuaOpenRequest _value) throws ParseException {
    ...
    public static class OpcuaOpenRequestBuilder implements MessagePDUIO.MessagePDUBuilder {
        ...
        public OpcuaOpenRequest build() {
            return new OpcuaOpenRequest(chunk, secureChannelId, endpoint, senderCertificate, receiverCertificateThumbprint, sequenceNumber, requestId, message);
        }
    }
