...
public class EnumValueTypeIO implements MessageIO<EnumValueType, EnumValueType> {

    private static final Logger LOGGER = LoggerFactory.getLogger(EnumValueTypeIO.class);

    @Override
    public EnumValueType parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (EnumValueType) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, EnumValueType value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static EnumValueTypeBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        ...
        // Simple Field (value)
long value = readBuffer.readLong("value", 64) ;
...
LocalizedText description = LocalizedTextIO.staticParse(readBuffer ) ;        readBuffer.closeContext("description");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, EnumValueType _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("EnumValueType");

        // Simple Field (value)
        long value = (long) _value.getValue();
        writeBuffer.writeLong("value", 64, ((Number) (value)).longValue());
    ...
    public static class EnumValueTypeBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
