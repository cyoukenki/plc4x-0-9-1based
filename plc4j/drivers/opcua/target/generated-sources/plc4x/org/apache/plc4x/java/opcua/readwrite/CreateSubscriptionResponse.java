...
public class CreateSubscriptionResponse extends ExtensionObjectDefinition implements Message {
    ...
    public CreateSubscriptionResponse(ExtensionObjectDefinition responseHeader, long subscriptionId, double revisedPublishingInterval, long revisedLifetimeCount, long revisedMaxKeepAliveCount) {
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("revisedPublishingInterval", getRevisedPublishingInterval())
            .append("revisedLifetimeCount", getRevisedLifetimeCount())
            .append("revisedMaxKeepAliveCount", getRevisedMaxKeepAliveCount())
            .toString();
    }
