...
public class HistoryUpdateResponseIO implements MessageIO<HistoryUpdateResponse, HistoryUpdateResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HistoryUpdateResponseIO.class);

    @Override
    public HistoryUpdateResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (HistoryUpdateResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, HistoryUpdateResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static HistoryUpdateResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(697) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new HistoryUpdateResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, HistoryUpdateResponse _value) throws ParseException {
    ...
    public static class HistoryUpdateResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public HistoryUpdateResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public HistoryUpdateResponse build() {
            return new HistoryUpdateResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
