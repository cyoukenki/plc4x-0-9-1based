...
public class CallResponseIO implements MessageIO<CallResponse, CallResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CallResponseIO.class);

    @Override
    public CallResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (CallResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, CallResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static CallResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(709) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new CallResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, CallResponse _value) throws ParseException {
    ...
    public static class CallResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public CallResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public CallResponse build() {
            return new CallResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
