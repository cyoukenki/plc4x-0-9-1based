...
public class OpcuaMessageResponseIO implements MessageIO<OpcuaMessageResponse, OpcuaMessageResponse> {
    ...
    @Override
    public OpcuaMessageResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (OpcuaMessageResponse) new MessagePDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, OpcuaMessageResponse value, Object... args) throws ParseException {
...
message[curItem] = readBuffer.readSignedByte("", 8) ;            }
        ...
        // Create the instance
        return new OpcuaMessageResponseBuilder(chunk, secureChannelId, secureTokenId, sequenceNumber, requestId, message);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, OpcuaMessageResponse _value) throws ParseException {
    ...
    public static class OpcuaMessageResponseBuilder implements MessagePDUIO.MessagePDUBuilder {
        ...
        public OpcuaMessageResponseBuilder(String chunk, int secureChannelId, int secureTokenId, int sequenceNumber, int requestId, byte[] message) {
            this.chunk = chunk;
        ...
        public OpcuaMessageResponse build() {
            return new OpcuaMessageResponse(chunk, secureChannelId, secureTokenId, sequenceNumber, requestId, message);
        }
    }
