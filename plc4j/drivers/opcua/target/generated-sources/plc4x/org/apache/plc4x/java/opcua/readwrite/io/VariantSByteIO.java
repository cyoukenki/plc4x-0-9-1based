...
public class VariantSByteIO implements MessageIO<VariantSByte, VariantSByte> {

    private static final Logger LOGGER = LoggerFactory.getLogger(VariantSByteIO.class);

    @Override
    public VariantSByte parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (VariantSByte) new VariantIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, VariantSByte value, Object... args) throws ParseException {
        new VariantIO().serialize(writeBuffer, value, args);
    }

    public static VariantSByteBuilder staticParse(ReadBuffer readBuffer, Boolean arrayLengthSpecified) throws ParseException {
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, VariantSByte _value) throws ParseException {
    ...
    public static class VariantSByteBuilder implements VariantIO.VariantBuilder {
        ...
        public VariantSByte build(boolean arrayLengthSpecified, boolean arrayDimensionsSpecified, Integer noOfArrayDimensions, boolean[] arrayDimensions) {
