...
public class BrowseResponseIO implements MessageIO<BrowseResponse, BrowseResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(BrowseResponseIO.class);

    @Override
    public BrowseResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (BrowseResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, BrowseResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static BrowseResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        readBuffer.pullContext("BrowseResponse");
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(524) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("BrowseResponse");
        // Create the instance
        return new BrowseResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, BrowseResponse _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("BrowseResponse");
        ...
        writeBuffer.popContext("BrowseResponse");
    }

    public static class BrowseResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public BrowseResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public BrowseResponse build() {
            return new BrowseResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
