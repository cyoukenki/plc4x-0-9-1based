...
public class DeleteNodesResponseIO implements MessageIO<DeleteNodesResponse, DeleteNodesResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteNodesResponseIO.class);

    @Override
    public DeleteNodesResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (DeleteNodesResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, DeleteNodesResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static DeleteNodesResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new DeleteNodesResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, DeleteNodesResponse _value) throws ParseException {
    ...
    public static class DeleteNodesResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public DeleteNodesResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public DeleteNodesResponse build() {
            return new DeleteNodesResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
