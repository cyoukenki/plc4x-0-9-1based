...
public class ProgramDiagnosticDataTypeIO implements MessageIO<ProgramDiagnosticDataType, ProgramDiagnosticDataType> {
    ...
    @Override
    public ProgramDiagnosticDataType parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ProgramDiagnosticDataType) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ProgramDiagnosticDataType value, Object... args) throws ParseException {
...
ExtensionObjectDefinition lastMethodReturnStatus = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(301) ) ;        readBuffer.closeContext("lastMethodReturnStatus");

        readBuffer.closeContext("ProgramDiagnosticDataType");
        // Create the instance
        return new ProgramDiagnosticDataTypeBuilder(createSessionId, createClientName, invocationCreationTime, lastTransitionTime, lastMethodCall, lastMethodSessionId, noOfLastMethodInputArguments, lastMethodInputArguments, noOfLastMethodOutputArguments, lastMethodOutputArguments, lastMethodCallTime, lastMethodReturnStatus);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, ProgramDiagnosticDataType _value) throws ParseException {
        ...
        // Simple Field (lastMethodReturnStatus)
        ExtensionObjectDefinition lastMethodReturnStatus = (ExtensionObjectDefinition) _value.getLastMethodReturnStatus();
    ...
    public static class ProgramDiagnosticDataTypeBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public ProgramDiagnosticDataTypeBuilder(NodeId createSessionId, PascalString createClientName, long invocationCreationTime, long lastTransitionTime, PascalString lastMethodCall, NodeId lastMethodSessionId, int noOfLastMethodInputArguments, ExtensionObjectDefinition[] lastMethodInputArguments, int noOfLastMethodOutputArguments, ExtensionObjectDefinition[] lastMethodOutputArguments, long lastMethodCallTime, ExtensionObjectDefinition lastMethodReturnStatus) {
        ...
        public ProgramDiagnosticDataType build() {
            return new ProgramDiagnosticDataType(createSessionId, createClientName, invocationCreationTime, lastTransitionTime, lastMethodCall, lastMethodSessionId, noOfLastMethodInputArguments, lastMethodInputArguments, noOfLastMethodOutputArguments, lastMethodOutputArguments, lastMethodCallTime, lastMethodReturnStatus);
        }
    }
