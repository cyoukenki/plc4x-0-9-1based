...
public class AdditionalParametersType extends ExtensionObjectDefinition implements Message {
    ...
    public AdditionalParametersType(int noOfParameters, ExtensionObjectDefinition[] parameters) {
    ...
    public ExtensionObjectDefinition[] getParameters() {
        return parameters;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(parameters != null) {
            ...
            for(ExtensionObjectDefinition element : parameters) {
                boolean last = ++i >= parameters.length;
    ...
    public boolean equals(Object o) {
        ...
        return
            (getNoOfParameters() == that.getNoOfParameters()) &&
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfParameters", getNoOfParameters())
