...
public class OpcuaOpenResponse extends MessagePDU implements Message {
    ...
    public OpcuaOpenResponse(String chunk, int secureChannelId, PascalString securityPolicyUri, PascalByteString senderCertificate, PascalByteString receiverCertificateThumbprint, int sequenceNumber, int requestId, byte[] message) {
        this.chunk = chunk;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("senderCertificate", getSenderCertificate())
            .append("receiverCertificateThumbprint", getReceiverCertificateThumbprint())
