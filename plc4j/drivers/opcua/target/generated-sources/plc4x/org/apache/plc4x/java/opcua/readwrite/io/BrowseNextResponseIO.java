...
public class BrowseNextResponseIO implements MessageIO<BrowseNextResponse, BrowseNextResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(BrowseNextResponseIO.class);

    @Override
    public BrowseNextResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (BrowseNextResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, BrowseNextResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static BrowseNextResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new BrowseNextResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, BrowseNextResponse _value) throws ParseException {
    ...
    public static class BrowseNextResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public BrowseNextResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public BrowseNextResponse build() {
            return new BrowseNextResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
