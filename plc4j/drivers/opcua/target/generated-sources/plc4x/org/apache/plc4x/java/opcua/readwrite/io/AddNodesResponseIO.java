...
public class AddNodesResponseIO implements MessageIO<AddNodesResponse, AddNodesResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddNodesResponseIO.class);

    @Override
    public AddNodesResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (AddNodesResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, AddNodesResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static AddNodesResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(485) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new AddNodesResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, AddNodesResponse _value) throws ParseException {
    ...
    public static class AddNodesResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public AddNodesResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public AddNodesResponse build() {
            return new AddNodesResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
