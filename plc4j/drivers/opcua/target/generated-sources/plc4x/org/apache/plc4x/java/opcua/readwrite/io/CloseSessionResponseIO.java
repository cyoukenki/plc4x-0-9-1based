...
public class CloseSessionResponseIO implements MessageIO<CloseSessionResponse, CloseSessionResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CloseSessionResponseIO.class);

    @Override
    public CloseSessionResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (CloseSessionResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, CloseSessionResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static CloseSessionResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
ExtensionObjectDefinition responseHeader = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(394) ) ;        readBuffer.closeContext("responseHeader");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, CloseSessionResponse _value) throws ParseException {
    ...
    public static class CloseSessionResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
