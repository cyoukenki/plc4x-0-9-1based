...
public class ContentFilterElementResult extends ExtensionObjectDefinition implements Message {
    ...
    public ContentFilterElementResult(StatusCode statusCode, int noOfOperandStatusCodes, StatusCode[] operandStatusCodes, int noOfOperandDiagnosticInfos, DiagnosticInfo[] operandDiagnosticInfos) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(operandStatusCodes != null) {
            ...
            for(StatusCode element : operandStatusCodes) {
                boolean last = ++i >= operandStatusCodes.length;
        ...
        if(operandDiagnosticInfos != null) {
            ...
            for(DiagnosticInfo element : operandDiagnosticInfos) {
                boolean last = ++i >= operandDiagnosticInfos.length;
                lengthInBits += element.getLengthInBitsConditional(last);
            }
        }
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfOperandStatusCodes", getNoOfOperandStatusCodes())
            .append("operandStatusCodes", getOperandStatusCodes())
            .append("noOfOperandDiagnosticInfos", getNoOfOperandDiagnosticInfos())
            .append("operandDiagnosticInfos", getOperandDiagnosticInfos())
            .toString();
    }
