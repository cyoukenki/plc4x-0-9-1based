...
public class GetEndpointsRequest extends ExtensionObjectDefinition implements Message {
    ...
    public GetEndpointsRequest(ExtensionObjectDefinition requestHeader, PascalString endpointUrl, int noOfLocaleIds, PascalString[] localeIds, int noOfProfileUris, PascalString[] profileUris) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(profileUris != null) {
            ...
            for(PascalString element : profileUris) {
                boolean last = ++i >= profileUris.length;
                lengthInBits += element.getLengthInBitsConditional(last);
            }
        }
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfProfileUris", getNoOfProfileUris())
            .append("profileUris", getProfileUris())
            .toString();
    }
