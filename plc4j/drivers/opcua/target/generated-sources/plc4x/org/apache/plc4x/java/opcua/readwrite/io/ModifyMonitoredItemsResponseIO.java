...
public class ModifyMonitoredItemsResponseIO implements MessageIO<ModifyMonitoredItemsResponse, ModifyMonitoredItemsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModifyMonitoredItemsResponseIO.class);

    @Override
    public ModifyMonitoredItemsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModifyMonitoredItemsResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModifyMonitoredItemsResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static ModifyMonitoredItemsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
results[curItem] = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(760) ) ;            }
        }
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new ModifyMonitoredItemsResponseBuilder(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, ModifyMonitoredItemsResponse _value) throws ParseException {
    ...
    public static class ModifyMonitoredItemsResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public ModifyMonitoredItemsResponseBuilder(ExtensionObjectDefinition responseHeader, int noOfResults, ExtensionObjectDefinition[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public ModifyMonitoredItemsResponse build() {
            return new ModifyMonitoredItemsResponse(responseHeader, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
