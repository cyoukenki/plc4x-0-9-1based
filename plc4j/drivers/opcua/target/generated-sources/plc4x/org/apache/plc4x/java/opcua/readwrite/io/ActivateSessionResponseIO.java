...
public class ActivateSessionResponseIO implements MessageIO<ActivateSessionResponse, ActivateSessionResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateSessionResponseIO.class);

    @Override
    public ActivateSessionResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ActivateSessionResponse) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ActivateSessionResponse value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static ActivateSessionResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
diagnosticInfos[curItem] = DiagnosticInfoIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new ActivateSessionResponseBuilder(responseHeader, serverNonce, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, ActivateSessionResponse _value) throws ParseException {
    ...
    public static class ActivateSessionResponseBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        ...
        public ActivateSessionResponseBuilder(ExtensionObjectDefinition responseHeader, PascalByteString serverNonce, int noOfResults, StatusCode[] results, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
        ...
        public ActivateSessionResponse build() {
            return new ActivateSessionResponse(responseHeader, serverNonce, noOfResults, results, noOfDiagnosticInfos, diagnosticInfos);
        }
    }
