...
public class CallMethodRequest extends ExtensionObjectDefinition implements Message {
    ...
    public CallMethodRequest(NodeId objectId, NodeId methodId, int noOfInputArguments, Variant[] inputArguments) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(inputArguments != null) {
            ...
            for(Variant element : inputArguments) {
                boolean last = ++i >= inputArguments.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfInputArguments", getNoOfInputArguments())
            .append("inputArguments", getInputArguments())
            .toString();
    }
