...
public class ServiceFaultIO implements MessageIO<ServiceFault, ServiceFault> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ServiceFaultIO.class);

    @Override
    public ServiceFault parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ServiceFault) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ServiceFault value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static ServiceFaultBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
ExtensionObjectDefinition responseHeader = ExtensionObjectDefinitionIO.staticParse(readBuffer , String.valueOf(394) ) ;        readBuffer.closeContext("responseHeader");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ServiceFault _value) throws ParseException {
    ...
    public static class ServiceFaultBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
