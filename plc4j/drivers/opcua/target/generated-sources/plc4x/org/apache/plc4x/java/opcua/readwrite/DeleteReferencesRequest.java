...
public class DeleteReferencesRequest extends ExtensionObjectDefinition implements Message {
    ...
    public DeleteReferencesRequest(ExtensionObjectDefinition requestHeader, int noOfReferencesToDelete, ExtensionObjectDefinition[] referencesToDelete) {
    ...
    public ExtensionObjectDefinition[] getReferencesToDelete() {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(referencesToDelete != null) {
            ...
            for(ExtensionObjectDefinition element : referencesToDelete) {
                boolean last = ++i >= referencesToDelete.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfReferencesToDelete", getNoOfReferencesToDelete())
            .append("referencesToDelete", getReferencesToDelete())
            .toString();
    }
