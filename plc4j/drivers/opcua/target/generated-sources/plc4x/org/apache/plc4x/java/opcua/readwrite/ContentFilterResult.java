...
public class ContentFilterResult extends ExtensionObjectDefinition implements Message {
    ...
    public ContentFilterResult(int noOfElementResults, ExtensionObjectDefinition[] elementResults, int noOfElementDiagnosticInfos, DiagnosticInfo[] elementDiagnosticInfos) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(elementResults != null) {
            ...
            for(ExtensionObjectDefinition element : elementResults) {
                boolean last = ++i >= elementResults.length;
        ...
        if(elementDiagnosticInfos != null) {
            ...
            for(DiagnosticInfo element : elementDiagnosticInfos) {
                boolean last = ++i >= elementDiagnosticInfos.length;
                lengthInBits += element.getLengthInBitsConditional(last);
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        return
            (getNoOfElementResults() == that.getNoOfElementResults()) &&
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfElementResults", getNoOfElementResults())
            .append("elementResults", getElementResults())
            .append("noOfElementDiagnosticInfos", getNoOfElementDiagnosticInfos())
