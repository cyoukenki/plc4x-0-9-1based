...
public class VariantByteIO implements MessageIO<VariantByte, VariantByte> {

    private static final Logger LOGGER = LoggerFactory.getLogger(VariantByteIO.class);

    @Override
    public VariantByte parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (VariantByte) new VariantIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, VariantByte value, Object... args) throws ParseException {
        new VariantIO().serialize(writeBuffer, value, args);
    }

    public static VariantByteBuilder staticParse(ReadBuffer readBuffer, Boolean arrayLengthSpecified) throws ParseException {
...
value[curItem] = readBuffer.readUnsignedShort("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, VariantByte _value) throws ParseException {
    ...
    public static class VariantByteBuilder implements VariantIO.VariantBuilder {
        private final Integer arrayLength;
        private final short[] value;

        public VariantByteBuilder(Integer arrayLength, short[] value) {
            this.arrayLength = arrayLength;
            this.value = value;
        }

        public VariantByte build(boolean arrayLengthSpecified, boolean arrayDimensionsSpecified, Integer noOfArrayDimensions, boolean[] arrayDimensions) {
