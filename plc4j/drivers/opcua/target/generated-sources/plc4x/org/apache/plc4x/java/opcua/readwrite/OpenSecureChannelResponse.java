...
public class OpenSecureChannelResponse extends ExtensionObjectDefinition implements Message {
    ...
    public OpenSecureChannelResponse(ExtensionObjectDefinition responseHeader, long serverProtocolVersion, ExtensionObjectDefinition securityToken, PascalByteString serverNonce) {
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("serverProtocolVersion", getServerProtocolVersion())
            .append("securityToken", getSecurityToken())
