...
public class AddNodesRequest extends ExtensionObjectDefinition implements Message {
    ...
    public AddNodesRequest(ExtensionObjectDefinition requestHeader, int noOfNodesToAdd, ExtensionObjectDefinition[] nodesToAdd) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(nodesToAdd != null) {
            ...
            for(ExtensionObjectDefinition element : nodesToAdd) {
                boolean last = ++i >= nodesToAdd.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfNodesToAdd", getNoOfNodesToAdd())
            .append("nodesToAdd", getNodesToAdd())
            .toString();
    }
