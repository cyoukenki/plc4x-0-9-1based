...
public class HistoryEventFieldListIO implements MessageIO<HistoryEventFieldList, HistoryEventFieldList> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HistoryEventFieldListIO.class);

    @Override
    public HistoryEventFieldList parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (HistoryEventFieldList) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, HistoryEventFieldList value, Object... args) throws ParseException {
        new ExtensionObjectDefinitionIO().serialize(writeBuffer, value, args);
    }

    public static HistoryEventFieldListBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
eventFields[curItem] = VariantIO.staticParse(readBuffer ) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, HistoryEventFieldList _value) throws ParseException {
    ...
    public static class HistoryEventFieldListBuilder implements ExtensionObjectDefinitionIO.ExtensionObjectDefinitionBuilder {
        private final int noOfEventFields;
        private final Variant[] eventFields;

        public HistoryEventFieldListBuilder(int noOfEventFields, Variant[] eventFields) {
            this.noOfEventFields = noOfEventFields;
            this.eventFields = eventFields;
        }

        public HistoryEventFieldList build() {
            return new HistoryEventFieldList(noOfEventFields, eventFields);
        }
    }
