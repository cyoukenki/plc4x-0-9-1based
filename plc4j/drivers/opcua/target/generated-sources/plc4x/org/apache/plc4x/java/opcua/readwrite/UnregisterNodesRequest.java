...
public class UnregisterNodesRequest extends ExtensionObjectDefinition implements Message {
    ...
    public UnregisterNodesRequest(ExtensionObjectDefinition requestHeader, int noOfNodesToUnregister, NodeId[] nodesToUnregister) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(nodesToUnregister != null) {
            ...
            for(NodeId element : nodesToUnregister) {
                boolean last = ++i >= nodesToUnregister.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfNodesToUnregister", getNoOfNodesToUnregister())
            .append("nodesToUnregister", getNodesToUnregister())
            .toString();
    }
