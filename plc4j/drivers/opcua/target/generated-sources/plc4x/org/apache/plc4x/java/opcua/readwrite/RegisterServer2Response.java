...
public class RegisterServer2Response extends ExtensionObjectDefinition implements Message {
    ...
    public RegisterServer2Response(ExtensionObjectDefinition responseHeader, int noOfConfigurationResults, StatusCode[] configurationResults, int noOfDiagnosticInfos, DiagnosticInfo[] diagnosticInfos) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(configurationResults != null) {
            ...
            for(StatusCode element : configurationResults) {
                boolean last = ++i >= configurationResults.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfConfigurationResults", getNoOfConfigurationResults())
            .append("configurationResults", getConfigurationResults())
