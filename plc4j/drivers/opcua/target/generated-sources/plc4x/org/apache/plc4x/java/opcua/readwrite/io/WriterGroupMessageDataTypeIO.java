...
public class WriterGroupMessageDataTypeIO implements MessageIO<WriterGroupMessageDataType, WriterGroupMessageDataType> {
    ...
    @Override
    public WriterGroupMessageDataType parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (WriterGroupMessageDataType) new ExtensionObjectDefinitionIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, WriterGroupMessageDataType value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, WriterGroupMessageDataType _value) throws ParseException {
