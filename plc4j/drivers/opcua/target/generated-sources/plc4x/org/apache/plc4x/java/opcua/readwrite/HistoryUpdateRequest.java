...
public class HistoryUpdateRequest extends ExtensionObjectDefinition implements Message {
    ...
    public HistoryUpdateRequest(ExtensionObjectDefinition requestHeader, int noOfHistoryUpdateDetails, ExtensionObject[] historyUpdateDetails) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(historyUpdateDetails != null) {
            ...
            for(ExtensionObject element : historyUpdateDetails) {
                boolean last = ++i >= historyUpdateDetails.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfHistoryUpdateDetails", getNoOfHistoryUpdateDetails())
            .append("historyUpdateDetails", getHistoryUpdateDetails())
            .toString();
    }
