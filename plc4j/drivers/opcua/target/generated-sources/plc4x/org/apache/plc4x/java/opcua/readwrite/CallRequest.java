...
public class CallRequest extends ExtensionObjectDefinition implements Message {
    ...
    public CallRequest(ExtensionObjectDefinition requestHeader, int noOfMethodsToCall, ExtensionObjectDefinition[] methodsToCall) {
    ...
    public ExtensionObjectDefinition[] getMethodsToCall() {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(methodsToCall != null) {
            ...
            for(ExtensionObjectDefinition element : methodsToCall) {
                boolean last = ++i >= methodsToCall.length;
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("noOfMethodsToCall", getNoOfMethodsToCall())
            .append("methodsToCall", getMethodsToCall())
            .toString();
    }
