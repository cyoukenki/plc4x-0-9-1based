...
public class VidData implements Message {
    ...
    public VidData(short dataLen, DataStruct[] values) {
    ...
    @Override
    public MessageIO<VidData, VidData> getMessageIO() {
        return new VidDataIO();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VidData)) {
            return false;
        }
        VidData that = (VidData) o;
        return
