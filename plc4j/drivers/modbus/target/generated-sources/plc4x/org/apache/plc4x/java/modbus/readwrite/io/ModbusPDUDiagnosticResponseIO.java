...
public class ModbusPDUDiagnosticResponseIO implements MessageIO<ModbusPDUDiagnosticResponse, ModbusPDUDiagnosticResponse> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUDiagnosticResponseIO.class);

    @Override
    public ModbusPDUDiagnosticResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUDiagnosticResponse) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUDiagnosticResponse value, Object... args) throws ParseException {
...
int data = readBuffer.readUnsignedInt("data", 16) ;
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUDiagnosticResponse _value) throws ParseException {
    ...
    public static class ModbusPDUDiagnosticResponseBuilder implements ModbusPDUIO.ModbusPDUBuilder {
        ...
        public ModbusPDUDiagnosticResponse build() {
            return new ModbusPDUDiagnosticResponse(subFunction, data);
        }
    }
