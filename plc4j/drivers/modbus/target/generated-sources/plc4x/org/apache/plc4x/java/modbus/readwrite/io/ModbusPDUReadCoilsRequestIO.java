...
public class ModbusPDUReadCoilsRequestIO implements MessageIO<ModbusPDUReadCoilsRequest, ModbusPDUReadCoilsRequest> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUReadCoilsRequestIO.class);

    @Override
    public ModbusPDUReadCoilsRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadCoilsRequest) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadCoilsRequest value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUReadCoilsRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
int quantity = readBuffer.readUnsignedInt("quantity", 16) ;
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadCoilsRequest _value) throws ParseException {
    ...
    public static class ModbusPDUReadCoilsRequestBuilder implements ModbusPDUIO.ModbusPDUBuilder {
