...
public class ModbusPDUReadHoldingRegistersResponseIO implements MessageIO<ModbusPDUReadHoldingRegistersResponse, ModbusPDUReadHoldingRegistersResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUReadHoldingRegistersResponseIO.class);

    @Override
    public ModbusPDUReadHoldingRegistersResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadHoldingRegistersResponse) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadHoldingRegistersResponse value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUReadHoldingRegistersResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadHoldingRegistersResponse _value) throws ParseException {
    ...
    public static class ModbusPDUReadHoldingRegistersResponseBuilder implements ModbusPDUIO.ModbusPDUBuilder {
