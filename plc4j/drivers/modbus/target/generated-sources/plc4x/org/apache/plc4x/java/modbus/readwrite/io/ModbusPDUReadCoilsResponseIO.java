...
public class ModbusPDUReadCoilsResponseIO implements MessageIO<ModbusPDUReadCoilsResponse, ModbusPDUReadCoilsResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUReadCoilsResponseIO.class);

    @Override
    public ModbusPDUReadCoilsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadCoilsResponse) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadCoilsResponse value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUReadCoilsResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadCoilsResponse _value) throws ParseException {
    ...
    public static class ModbusPDUReadCoilsResponseBuilder implements ModbusPDUIO.ModbusPDUBuilder {
