...
public class ModbusPDUReadFileRecordResponseIO implements MessageIO<ModbusPDUReadFileRecordResponse, ModbusPDUReadFileRecordResponse> {
    ...
    @Override
    public ModbusPDUReadFileRecordResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadFileRecordResponse) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadFileRecordResponse value, Object... args) throws ParseException {
    ...
    public static ModbusPDUReadFileRecordResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        ...
        while(readBuffer.getPos() < itemsEndPos) {
            _itemsList.add(ModbusPDUReadFileRecordResponseItemIO.staticParse(readBuffer));
        }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadFileRecordResponse _value) throws ParseException {
        ...
        if(_value.getItems() != null) {
            ...
            int curItem = 0;
            for(ModbusPDUReadFileRecordResponseItem element : _value.getItems()) {
                boolean lastItem = curItem == (itemCount - 1);
                ModbusPDUReadFileRecordResponseItemIO.staticSerialize(writeBuffer, element);
                curItem++;
            }
    ...
    public static class ModbusPDUReadFileRecordResponseBuilder implements ModbusPDUIO.ModbusPDUBuilder {
        ...
        public ModbusPDUReadFileRecordResponseBuilder(ModbusPDUReadFileRecordResponseItem[] items) {
            this.items = items;
        }
