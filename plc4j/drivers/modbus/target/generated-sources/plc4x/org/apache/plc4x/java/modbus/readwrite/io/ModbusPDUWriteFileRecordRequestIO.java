...
public class ModbusPDUWriteFileRecordRequestIO implements MessageIO<ModbusPDUWriteFileRecordRequest, ModbusPDUWriteFileRecordRequest> {
    ...
    @Override
    public ModbusPDUWriteFileRecordRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUWriteFileRecordRequest) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUWriteFileRecordRequest value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUWriteFileRecordRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        ...
        while(readBuffer.getPos() < itemsEndPos) {
            _itemsList.add(ModbusPDUWriteFileRecordRequestItemIO.staticParse(readBuffer));
        }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUWriteFileRecordRequest _value) throws ParseException {
        ...
        if(_value.getItems() != null) {
            ...
            int curItem = 0;
            for(ModbusPDUWriteFileRecordRequestItem element : _value.getItems()) {
                boolean lastItem = curItem == (itemCount - 1);
                ModbusPDUWriteFileRecordRequestItemIO.staticSerialize(writeBuffer, element);
                curItem++;
            }
    ...
    public static class ModbusPDUWriteFileRecordRequestBuilder implements ModbusPDUIO.ModbusPDUBuilder {
        ...
        public ModbusPDUWriteFileRecordRequestBuilder(ModbusPDUWriteFileRecordRequestItem[] items) {
            this.items = items;
        }
