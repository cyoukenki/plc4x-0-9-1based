...
public class ModbusPDUReadDiscreteInputsResponseIO implements MessageIO<ModbusPDUReadDiscreteInputsResponse, ModbusPDUReadDiscreteInputsResponse> {
    ...
    @Override
    public ModbusPDUReadDiscreteInputsResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadDiscreteInputsResponse) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadDiscreteInputsResponse value, Object... args) throws ParseException {
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadDiscreteInputsResponse _value) throws ParseException {
