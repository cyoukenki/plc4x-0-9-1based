...
public class ModbusPDUWriteFileRecordRequestItemIO implements MessageIO<ModbusPDUWriteFileRecordRequestItem, ModbusPDUWriteFileRecordRequestItem> {
    ...
    @Override
    public ModbusPDUWriteFileRecordRequestItem parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return ModbusPDUWriteFileRecordRequestItemIO.staticParse(readBuffer);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUWriteFileRecordRequestItem value, Object... args) throws ParseException {
        ModbusPDUWriteFileRecordRequestItemIO.staticSerialize(writeBuffer, value);
    }
...
int recordNumber = readBuffer.readUnsignedInt("recordNumber", 16) ;
        ...
        // Length array
        long _recordDataLength = (recordLength) * (2);
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUWriteFileRecordRequestItem _value) throws ParseException {
