...
public class ModbusPDUReadHoldingRegistersRequestIO implements MessageIO<ModbusPDUReadHoldingRegistersRequest, ModbusPDUReadHoldingRegistersRequest> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUReadHoldingRegistersRequestIO.class);

    @Override
    public ModbusPDUReadHoldingRegistersRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadHoldingRegistersRequest) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadHoldingRegistersRequest value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUReadHoldingRegistersRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
int quantity = readBuffer.readUnsignedInt("quantity", 16) ;
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadHoldingRegistersRequest _value) throws ParseException {
    ...
    public static class ModbusPDUReadHoldingRegistersRequestBuilder implements ModbusPDUIO.ModbusPDUBuilder {
