...
public class ModbusPDUReadWriteMultipleHoldingRegistersResponseIO implements MessageIO<ModbusPDUReadWriteMultipleHoldingRegistersResponse, ModbusPDUReadWriteMultipleHoldingRegistersResponse> {
    ...
    @Override
    public ModbusPDUReadWriteMultipleHoldingRegistersResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadWriteMultipleHoldingRegistersResponse) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadWriteMultipleHoldingRegistersResponse value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUReadWriteMultipleHoldingRegistersResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadWriteMultipleHoldingRegistersResponse _value) throws ParseException {
