...
public class ModbusPDUReadWriteMultipleHoldingRegistersRequestIO implements MessageIO<ModbusPDUReadWriteMultipleHoldingRegistersRequest, ModbusPDUReadWriteMultipleHoldingRegistersRequest> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUReadWriteMultipleHoldingRegistersRequestIO.class);

    @Override
    public ModbusPDUReadWriteMultipleHoldingRegistersRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUReadWriteMultipleHoldingRegistersRequest) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUReadWriteMultipleHoldingRegistersRequest value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUReadWriteMultipleHoldingRegistersRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
int readStartingAddress = readBuffer.readUnsignedInt("readStartingAddress", 16) ;

        // Simple Field (readQuantity)
int readQuantity = readBuffer.readUnsignedInt("readQuantity", 16) ;

        // Simple Field (writeStartingAddress)
int writeStartingAddress = readBuffer.readUnsignedInt("writeStartingAddress", 16) ;

        // Simple Field (writeQuantity)
int writeQuantity = readBuffer.readUnsignedInt("writeQuantity", 16) ;
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUReadWriteMultipleHoldingRegistersRequest _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("ModbusPDUReadWriteMultipleHoldingRegistersRequest");

        // Simple Field (readStartingAddress)
        int readStartingAddress = (int) _value.getReadStartingAddress();
        writeBuffer.writeUnsignedInt("readStartingAddress", 16, ((Number) (readStartingAddress)).intValue());

        // Simple Field (readQuantity)
        int readQuantity = (int) _value.getReadQuantity();
        writeBuffer.writeUnsignedInt("readQuantity", 16, ((Number) (readQuantity)).intValue());

        // Simple Field (writeStartingAddress)
        int writeStartingAddress = (int) _value.getWriteStartingAddress();
        writeBuffer.writeUnsignedInt("writeStartingAddress", 16, ((Number) (writeStartingAddress)).intValue());

        // Simple Field (writeQuantity)
        int writeQuantity = (int) _value.getWriteQuantity();
        writeBuffer.writeUnsignedInt("writeQuantity", 16, ((Number) (writeQuantity)).intValue());
    ...
    public static class ModbusPDUReadWriteMultipleHoldingRegistersRequestBuilder implements ModbusPDUIO.ModbusPDUBuilder {
