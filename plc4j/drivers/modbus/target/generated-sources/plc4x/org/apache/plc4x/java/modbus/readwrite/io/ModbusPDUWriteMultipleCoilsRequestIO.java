...
public class ModbusPDUWriteMultipleCoilsRequestIO implements MessageIO<ModbusPDUWriteMultipleCoilsRequest, ModbusPDUWriteMultipleCoilsRequest> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusPDUWriteMultipleCoilsRequestIO.class);

    @Override
    public ModbusPDUWriteMultipleCoilsRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (ModbusPDUWriteMultipleCoilsRequest) new ModbusPDUIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, ModbusPDUWriteMultipleCoilsRequest value, Object... args) throws ParseException {
        new ModbusPDUIO().serialize(writeBuffer, value, args);
    }

    public static ModbusPDUWriteMultipleCoilsRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
value[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, ModbusPDUWriteMultipleCoilsRequest _value) throws ParseException {
    ...
    public static class ModbusPDUWriteMultipleCoilsRequestBuilder implements ModbusPDUIO.ModbusPDUBuilder {
        private final int startingAddress;
        private final int quantity;
        private final byte[] value;

        public ModbusPDUWriteMultipleCoilsRequestBuilder(int startingAddress, int quantity, byte[] value) {
