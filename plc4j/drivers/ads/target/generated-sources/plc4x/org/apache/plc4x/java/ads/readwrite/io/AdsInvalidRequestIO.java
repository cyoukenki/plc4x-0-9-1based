...
public class AdsInvalidRequestIO implements MessageIO<AdsInvalidRequest, AdsInvalidRequest> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AdsInvalidRequestIO.class);

    @Override
    public AdsInvalidRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (AdsInvalidRequest) new AdsDataIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, AdsInvalidRequest value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, AdsInvalidRequest _value) throws ParseException {
