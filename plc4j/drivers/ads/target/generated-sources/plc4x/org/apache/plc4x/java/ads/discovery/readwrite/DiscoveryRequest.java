...
public class DiscoveryRequest extends AdsDiscovery implements Message {
    ...
    public DiscoveryRequest(Operation operation, Direction direction, AmsNetId amsNetId) {
