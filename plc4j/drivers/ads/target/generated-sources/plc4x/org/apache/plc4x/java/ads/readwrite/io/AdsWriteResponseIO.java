...
public class AdsWriteResponseIO implements MessageIO<AdsWriteResponse, AdsWriteResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AdsWriteResponseIO.class);

    @Override
    public AdsWriteResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (AdsWriteResponse) new AdsDataIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, AdsWriteResponse value, Object... args) throws ParseException {
        new AdsDataIO().serialize(writeBuffer, value, args);
    }

    public static AdsWriteResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, AdsWriteResponse _value) throws ParseException {
    ...
    public static class AdsWriteResponseBuilder implements AdsDataIO.AdsDataBuilder {
        ...
        public AdsWriteResponse build() {
            return new AdsWriteResponse(result);
        }
    }
