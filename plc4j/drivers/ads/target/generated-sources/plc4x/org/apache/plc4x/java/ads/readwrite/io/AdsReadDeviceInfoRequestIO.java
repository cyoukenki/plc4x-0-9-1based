...
public class AdsReadDeviceInfoRequestIO implements MessageIO<AdsReadDeviceInfoRequest, AdsReadDeviceInfoRequest> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AdsReadDeviceInfoRequestIO.class);

    @Override
    public AdsReadDeviceInfoRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (AdsReadDeviceInfoRequest) new AdsDataIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, AdsReadDeviceInfoRequest value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, AdsReadDeviceInfoRequest _value) throws ParseException {
