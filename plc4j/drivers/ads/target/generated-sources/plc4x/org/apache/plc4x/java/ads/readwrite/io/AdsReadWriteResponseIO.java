...
public class AdsReadWriteResponseIO implements MessageIO<AdsReadWriteResponse, AdsReadWriteResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AdsReadWriteResponseIO.class);

    @Override
    public AdsReadWriteResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (AdsReadWriteResponse) new AdsDataIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, AdsReadWriteResponse value, Object... args) throws ParseException {
        new AdsDataIO().serialize(writeBuffer, value, args);
    }

    public static AdsReadWriteResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
data[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, AdsReadWriteResponse _value) throws ParseException {
    ...
    public static class AdsReadWriteResponseBuilder implements AdsDataIO.AdsDataBuilder {
        ...
        public AdsReadWriteResponse build() {
            return new AdsReadWriteResponse(result, data);
        }
    }
