...
public class SDOInitiateExpeditedUploadResponseIO implements MessageIO<SDOInitiateExpeditedUploadResponse, SDOInitiateExpeditedUploadResponse> {
    ...
    @Override
    public SDOInitiateExpeditedUploadResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SDOInitiateExpeditedUploadResponse) new SDOInitiateUploadResponsePayloadIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SDOInitiateExpeditedUploadResponse value, Object... args) throws ParseException {
        new SDOInitiateUploadResponsePayloadIO().serialize(writeBuffer, value, args);
    }

    public static SDOInitiateExpeditedUploadResponseBuilder staticParse(ReadBuffer readBuffer, Byte size) throws ParseException {
        ...
        // Count array
        if((4) - (size) > Integer.MAX_VALUE) {
            throw new ParseException("Array count of " + ((4) - (size)) + " exceeds the maximum allowed count of " + Integer.MAX_VALUE);
        }
        byte[] data;
        {
            int itemCount = Math.max(0, (int) (4) - (size));
...
data[curItem] = readBuffer.readSignedByte("", 8) ;            }
        ...
        // Create the instance
        return new SDOInitiateExpeditedUploadResponseBuilder(data);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, SDOInitiateExpeditedUploadResponse _value) throws ParseException {
    ...
    public static class SDOInitiateExpeditedUploadResponseBuilder implements SDOInitiateUploadResponsePayloadIO.SDOInitiateUploadResponsePayloadBuilder {
        ...
        public SDOInitiateExpeditedUploadResponseBuilder(byte[] data) {
            this.data = data;
        }
