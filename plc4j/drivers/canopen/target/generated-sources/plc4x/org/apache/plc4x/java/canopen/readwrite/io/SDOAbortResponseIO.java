...
public class SDOAbortResponseIO implements MessageIO<SDOAbortResponse, SDOAbortResponse> {
    ...
    @Override
    public SDOAbortResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SDOAbortResponse) new SDOResponseIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SDOAbortResponse value, Object... args) throws ParseException {
...
SDOAbort abort = SDOAbortIO.staticParse(readBuffer ) ;        readBuffer.closeContext("abort");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, SDOAbortResponse _value) throws ParseException {
