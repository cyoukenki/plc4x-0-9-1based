...
public class SDOInitiateDownloadResponseIO implements MessageIO<SDOInitiateDownloadResponse, SDOInitiateDownloadResponse> {
    ...
    @Override
    public SDOInitiateDownloadResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SDOInitiateDownloadResponse) new SDOResponseIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SDOInitiateDownloadResponse value, Object... args) throws ParseException {
...
IndexAddress address = IndexAddressIO.staticParse(readBuffer ) ;        readBuffer.closeContext("address");
        ...
        // Create the instance
        return new SDOInitiateDownloadResponseBuilder(address);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, SDOInitiateDownloadResponse _value) throws ParseException {
    ...
    public static class SDOInitiateDownloadResponseBuilder implements SDOResponseIO.SDOResponseBuilder {
        ...
        public SDOInitiateDownloadResponseBuilder(IndexAddress address) {
