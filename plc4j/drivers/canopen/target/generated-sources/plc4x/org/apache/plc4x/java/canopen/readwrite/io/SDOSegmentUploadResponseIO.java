...
public class SDOSegmentUploadResponseIO implements MessageIO<SDOSegmentUploadResponse, SDOSegmentUploadResponse> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SDOSegmentUploadResponseIO.class);

    @Override
    public SDOSegmentUploadResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SDOSegmentUploadResponse) new SDOResponseIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SDOSegmentUploadResponse value, Object... args) throws ParseException {
        new SDOResponseIO().serialize(writeBuffer, value, args);
    }

    public static SDOSegmentUploadResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
data[curItem] = readBuffer.readSignedByte("", 8) ;            }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, SDOSegmentUploadResponse _value) throws ParseException {
    ...
    public static class SDOSegmentUploadResponseBuilder implements SDOResponseIO.SDOResponseBuilder {
