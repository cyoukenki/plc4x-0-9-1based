...
public class CANOpenPDOPayloadIO implements MessageIO<CANOpenPDOPayload, CANOpenPDOPayload> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CANOpenPDOPayloadIO.class);

    @Override
    public CANOpenPDOPayload parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (CANOpenPDOPayload) new CANOpenPayloadIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, CANOpenPDOPayload value, Object... args) throws ParseException {
    ...
    public static CANOpenPDOPayloadBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        ...
        readBuffer.pullContext("pdo");

        // Simple Field (pdo)
CANOpenPDO pdo = CANOpenPDOIO.staticParse(readBuffer , (byte) (1), (boolean) (false) ) ;        readBuffer.closeContext("pdo");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, CANOpenPDOPayload _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("CANOpenPDOPayload");

        // Simple Field (pdo)
        CANOpenPDO pdo = (CANOpenPDO) _value.getPdo();
        writeBuffer.pushContext("pdo");
        CANOpenPDOIO.staticSerialize(writeBuffer, pdo);
        writeBuffer.popContext("pdo");
