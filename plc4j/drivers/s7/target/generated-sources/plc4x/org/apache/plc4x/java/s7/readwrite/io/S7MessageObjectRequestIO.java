...
public class S7MessageObjectRequestIO implements MessageIO<S7MessageObjectRequest, S7MessageObjectRequest> {
    ...
    @Override
    public S7MessageObjectRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7MessageObjectRequest) new S7DataAlarmMessageIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7MessageObjectRequest value, Object... args) throws ParseException {
    ...
    public static S7MessageObjectRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        ...
        if(variableSpec != S7MessageObjectRequest.VARIABLESPEC) {
            throw new ParseException("Expected constant value " + S7MessageObjectRequest.VARIABLESPEC + " but got " + variableSpec);
        }

        // Const Field (length)
        short length = readBuffer.readUnsignedShort("length", 8);
        if(length != S7MessageObjectRequest.LENGTH) {
            throw new ParseException("Expected constant value " + S7MessageObjectRequest.LENGTH + " but got " + length);
        }
        ...
        // Create the instance
        return new S7MessageObjectRequestBuilder(syntaxId, queryType, alarmType);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, S7MessageObjectRequest _value) throws ParseException {
    ...
    public static class S7MessageObjectRequestBuilder implements S7DataAlarmMessageIO.S7DataAlarmMessageBuilder {
        ...
        public S7MessageObjectRequestBuilder(SyntaxIdType syntaxId, QueryType queryType, AlarmType alarmType) {
