...
public abstract class COTPPacket implements Message {
    ...
    // Properties.
    private final COTPParameter[] parameters;
    private final S7Message payload;

    public COTPPacket(COTPParameter[] parameters, S7Message payload) {
        this.parameters = parameters;
        this.payload = payload;
    }

    public COTPParameter[] getParameters() {
        return parameters;
    }
