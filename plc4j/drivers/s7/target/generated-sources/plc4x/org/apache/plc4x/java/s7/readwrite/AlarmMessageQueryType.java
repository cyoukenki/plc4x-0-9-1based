...
public class AlarmMessageQueryType implements Message {
    ...
    // Constant values.
    public static final int DATALENGTH = 0xFFFF;
    ...
    public AlarmMessageQueryType(short functionId, short numberOfObjects, DataTransportErrorCode returnCode, DataTransportSize transportSize, AlarmMessageObjectQueryType[] messageObjects) {
