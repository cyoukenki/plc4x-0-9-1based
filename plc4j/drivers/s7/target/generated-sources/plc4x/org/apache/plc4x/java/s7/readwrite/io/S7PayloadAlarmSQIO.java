...
public class S7PayloadAlarmSQIO implements MessageIO<S7PayloadAlarmSQ, S7PayloadAlarmSQ> {
    ...
    @Override
    public S7PayloadAlarmSQ parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7PayloadAlarmSQ) new S7PayloadUserDataItemIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7PayloadAlarmSQ value, Object... args) throws ParseException {
...
AlarmMessagePushType alarmMessage = AlarmMessagePushTypeIO.staticParse(readBuffer ) ;        readBuffer.closeContext("alarmMessage");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, S7PayloadAlarmSQ _value) throws ParseException {
    ...
    public static class S7PayloadAlarmSQBuilder implements S7PayloadUserDataItemIO.S7PayloadUserDataItemBuilder {
        ...
        public S7PayloadAlarmSQ build(DataTransportErrorCode returnCode, DataTransportSize transportSize) {
            return new S7PayloadAlarmSQ(returnCode, transportSize, alarmMessage);
        }
    }
