...
public class S7PayloadWriteVarRequest extends S7Payload implements Message {
    ...
    public S7PayloadWriteVarRequest(S7VarPayloadDataItem[] items) {
        this.items = items;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        S7PayloadWriteVarRequest _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S7PayloadWriteVarRequest)) {
            return false;
        }
