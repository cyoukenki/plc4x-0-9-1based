...
public class S7ParameterReadVarRequestIO implements MessageIO<S7ParameterReadVarRequest, S7ParameterReadVarRequest> {

    private static final Logger LOGGER = LoggerFactory.getLogger(S7ParameterReadVarRequestIO.class);

    @Override
    public S7ParameterReadVarRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7ParameterReadVarRequest) new S7ParameterIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7ParameterReadVarRequest value, Object... args) throws ParseException {
        new S7ParameterIO().serialize(writeBuffer, value, args);
    }

    public static S7ParameterReadVarRequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
...
items[curItem] = S7VarRequestParameterItemIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("S7ParameterReadVarRequest");
        // Create the instance
        return new S7ParameterReadVarRequestBuilder(items);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, S7ParameterReadVarRequest _value) throws ParseException {
    ...
    public static class S7ParameterReadVarRequestBuilder implements S7ParameterIO.S7ParameterBuilder {
        private final S7VarRequestParameterItem[] items;

        public S7ParameterReadVarRequestBuilder(S7VarRequestParameterItem[] items) {
            this.items = items;
        }
