...
public class COTPPacketConnectionRequestIO implements MessageIO<COTPPacketConnectionRequest, COTPPacketConnectionRequest> {
    ...
    @Override
    public COTPPacketConnectionRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (COTPPacketConnectionRequest) new COTPPacketIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, COTPPacketConnectionRequest value, Object... args) throws ParseException {
...
int sourceReference = readBuffer.readUnsignedInt("sourceReference", 16) ;
        ...
        // Create the instance
        return new COTPPacketConnectionRequestBuilder(destinationReference, sourceReference, protocolClass);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, COTPPacketConnectionRequest _value) throws ParseException {
    ...
    public static class COTPPacketConnectionRequestBuilder implements COTPPacketIO.COTPPacketBuilder {
        ...
        public COTPPacketConnectionRequestBuilder(int destinationReference, int sourceReference, COTPProtocolClass protocolClass) {
            this.destinationReference = destinationReference;
            this.sourceReference = sourceReference;
            this.protocolClass = protocolClass;
        }

        public COTPPacketConnectionRequest build(COTPParameter[] parameters, S7Message payload) {
