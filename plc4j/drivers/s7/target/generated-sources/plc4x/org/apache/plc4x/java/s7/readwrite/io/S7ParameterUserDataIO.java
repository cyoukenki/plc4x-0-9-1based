...
public class S7ParameterUserDataIO implements MessageIO<S7ParameterUserData, S7ParameterUserData> {
    ...
    @Override
    public S7ParameterUserData parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7ParameterUserData) new S7ParameterIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7ParameterUserData value, Object... args) throws ParseException {
    ...
    public static S7ParameterUserDataBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        ...
        S7ParameterUserDataItem[] items;
        {
            int itemCount = Math.max(0, (int) numItems);
            items = new S7ParameterUserDataItem[itemCount];
            for(int curItem = 0; curItem < itemCount; curItem++) {
                boolean lastItem = curItem == (itemCount - 1);
items[curItem] = S7ParameterUserDataItemIO.staticParse(readBuffer ) ;            }
        }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, S7ParameterUserData _value) throws ParseException {
        ...
        if(_value.getItems() != null) {
            ...
            int curItem = 0;
            for(S7ParameterUserDataItem element : _value.getItems()) {
                boolean lastItem = curItem == (itemCount - 1);
                S7ParameterUserDataItemIO.staticSerialize(writeBuffer, element);
                curItem++;
            }
    ...
    public static class S7ParameterUserDataBuilder implements S7ParameterIO.S7ParameterBuilder {
        ...
        public S7ParameterUserDataBuilder(S7ParameterUserDataItem[] items) {
            this.items = items;
        }
