...
public class S7MessageUserDataIO implements MessageIO<S7MessageUserData, S7MessageUserData> {
    ...
    @Override
    public S7MessageUserData parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7MessageUserData) new S7MessageIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7MessageUserData value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, S7MessageUserData _value) throws ParseException {
    ...
    public static class S7MessageUserDataBuilder implements S7MessageIO.S7MessageBuilder {
        ...
        public S7MessageUserDataBuilder() {
        }
