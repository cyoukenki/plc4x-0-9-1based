...
public class S7ParameterReadVarResponseIO implements MessageIO<S7ParameterReadVarResponse, S7ParameterReadVarResponse> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(S7ParameterReadVarResponseIO.class);

    @Override
    public S7ParameterReadVarResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7ParameterReadVarResponse) new S7ParameterIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7ParameterReadVarResponse value, Object... args) throws ParseException {
...
short numItems = readBuffer.readUnsignedShort("numItems", 8) ;
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, S7ParameterReadVarResponse _value) throws ParseException {
