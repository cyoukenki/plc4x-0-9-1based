...
public class S7PayloadAlarmAckIndIO implements MessageIO<S7PayloadAlarmAckInd, S7PayloadAlarmAckInd> {
    ...
    @Override
    public S7PayloadAlarmAckInd parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7PayloadAlarmAckInd) new S7PayloadUserDataItemIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7PayloadAlarmAckInd value, Object... args) throws ParseException {
...
AlarmMessageAckPushType alarmMessage = AlarmMessageAckPushTypeIO.staticParse(readBuffer ) ;        readBuffer.closeContext("alarmMessage");
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, S7PayloadAlarmAckInd _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("S7PayloadAlarmAckInd");

        // Simple Field (alarmMessage)
        AlarmMessageAckPushType alarmMessage = (AlarmMessageAckPushType) _value.getAlarmMessage();
    ...
    public static class S7PayloadAlarmAckIndBuilder implements S7PayloadUserDataItemIO.S7PayloadUserDataItemBuilder {
        ...
        public S7PayloadAlarmAckInd build(DataTransportErrorCode returnCode, DataTransportSize transportSize) {
            return new S7PayloadAlarmAckInd(returnCode, transportSize, alarmMessage);
        }
    }
