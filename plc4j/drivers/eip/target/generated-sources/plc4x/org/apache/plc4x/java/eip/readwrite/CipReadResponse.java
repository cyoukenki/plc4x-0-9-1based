...
public class CipReadResponse extends CipService implements Message {
    ...
    public CipReadResponse(ReadResponseContent readResponseContent) {
        this.readResponseContent = readResponseContent;
    }

    public ReadResponseContent getReadResponseContent() {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        lengthInBits += readResponseContent.getLengthInBits();
    ...
    public boolean equals(Object o) {
        ...
        return
            (getReadResponseContent() == that.getReadResponseContent()) &&
            super.equals(that) &&
            true;
    }
    ...
    public String toString(ToStringStyle style) {
        return new ToStringBuilder(this, style)
            ...
            .append("readResponseContent", getReadResponseContent())
            .toString();
    }
