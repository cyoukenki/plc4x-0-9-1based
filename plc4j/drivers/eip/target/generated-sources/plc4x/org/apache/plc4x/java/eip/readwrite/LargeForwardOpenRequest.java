...
public class LargeForwardOpenRequest extends CipService implements Message {
    ...
    public static final long CONNECTION_PATH = 0x01240220;
    ...
    public LargeForwardOpenRequest(long o_t_id, long t_o_id, int connection_serial_number, long originator_serial_number) {
        this.o_t_id = o_t_id;
        this.t_o_id = t_o_id;
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        LargeForwardOpenRequest _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LargeForwardOpenRequest)) {
            return false;
        }
        LargeForwardOpenRequest that = (LargeForwardOpenRequest) o;
        return
            (getO_t_id() == that.getO_t_id()) &&
