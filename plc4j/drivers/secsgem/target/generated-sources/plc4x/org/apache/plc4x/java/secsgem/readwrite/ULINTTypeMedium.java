...
public class ULINTTypeMedium extends DataStruct3 implements Message {
    ...
    public ULINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ULINTTypeMedium)) {
            return false;
        }
        ULINTTypeMedium that = (ULINTTypeMedium) o;
        return
