...
public class S7F20ResponseIO implements MessageIO<S7F20Response, S7F20Response> {

    private static final Logger LOGGER = LoggerFactory.getLogger(S7F20ResponseIO.class);

    @Override
    public S7F20Response parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S7F20Response) new SecsPacketIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S7F20Response value, Object... args) throws ParseException {
        new SecsPacketIO().serialize(writeBuffer, value, args);
    }

    public static S7F20ResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        readBuffer.pullContext("S7F20Response");
...
values[curItem] = DataStructIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("S7F20Response");
        // Create the instance
        return new S7F20ResponseBuilder(symbolTypeDS, values);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, S7F20Response _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("S7F20Response");
        ...
        writeBuffer.popContext("S7F20Response");
    }

    public static class S7F20ResponseBuilder implements SecsPacketIO.SecsPacketBuilder {
        private final DataStruct2 symbolTypeDS;
        private final DataStruct[] values;

        public S7F20ResponseBuilder(DataStruct2 symbolTypeDS, DataStruct[] values) {
            this.symbolTypeDS = symbolTypeDS;
            this.values = values;
        }

        public S7F20Response build(int deviceID, short PType, short Stype, long systemBytes) {
            return new S7F20Response(deviceID, PType, Stype, systemBytes, symbolTypeDS, values);
        }
    }
