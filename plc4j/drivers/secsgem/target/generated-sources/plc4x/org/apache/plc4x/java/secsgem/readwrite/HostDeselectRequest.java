...
public class HostDeselectRequest extends SecsPacket implements Message {
    ...
    public HostDeselectRequest(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        HostDeselectRequest _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostDeselectRequest)) {
            return false;
        }
        HostDeselectRequest that = (HostDeselectRequest) o;
        return
            super.equals(that) &&
            true;
    }
