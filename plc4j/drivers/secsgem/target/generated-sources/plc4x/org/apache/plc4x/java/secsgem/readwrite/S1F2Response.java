...
public class S1F2Response extends SecsPacket implements Message {
    ...
    public S1F2Response(int deviceID, short PType, short Stype, long systemBytes, short len, DataStruct[] values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S1F2Response)) {
            return false;
        }
        S1F2Response that = (S1F2Response) o;
        return
            (getLen() == that.getLen()) &&
