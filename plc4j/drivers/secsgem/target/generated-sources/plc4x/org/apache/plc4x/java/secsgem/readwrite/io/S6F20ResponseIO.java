...
public class S6F20ResponseIO implements MessageIO<S6F20Response, S6F20Response> {

    private static final Logger LOGGER = LoggerFactory.getLogger(S6F20ResponseIO.class);

    @Override
    public S6F20Response parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S6F20Response) new SecsPacketIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S6F20Response value, Object... args) throws ParseException {
        new SecsPacketIO().serialize(writeBuffer, value, args);
    }

    public static S6F20ResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        readBuffer.pullContext("S6F20Response");
...
values[curItem] = DataStructIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("S6F20Response");
        // Create the instance
        return new S6F20ResponseBuilder(symbolTypeDS, values);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, S6F20Response _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("S6F20Response");
        ...
        writeBuffer.popContext("S6F20Response");
    }

    public static class S6F20ResponseBuilder implements SecsPacketIO.SecsPacketBuilder {
        private final DataStruct2 symbolTypeDS;
        private final DataStruct[] values;

        public S6F20ResponseBuilder(DataStruct2 symbolTypeDS, DataStruct[] values) {
            this.symbolTypeDS = symbolTypeDS;
            this.values = values;
        }

        public S6F20Response build(int deviceID, short PType, short Stype, long systemBytes) {
            return new S6F20Response(deviceID, PType, Stype, systemBytes, symbolTypeDS, values);
        }
    }
