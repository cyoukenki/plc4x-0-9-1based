...
values[curItem] = RPTIDListDataStructIO.staticParse(readBuffer ) ;            }
        ...
        // Create the instance
        return new S6F11RequestBuilder(dataId, ceId, symbolTypeDS, values);
    }
    ...
    public static class S6F11RequestBuilder implements SecsPacketIO.SecsPacketBuilder {
        ...
        public S6F11RequestBuilder(DataStruct dataId, DataStruct ceId, DataStruct2 symbolTypeDS, RPTIDListDataStruct[] values) {
            this.dataId = dataId;
            this.ceId = ceId;
        ...
        public S6F11Request build(int deviceID, short PType, short Stype, long systemBytes) {
            return new S6F11Request(deviceID, PType, Stype, systemBytes, dataId, ceId, symbolTypeDS, values);
        }
    }
