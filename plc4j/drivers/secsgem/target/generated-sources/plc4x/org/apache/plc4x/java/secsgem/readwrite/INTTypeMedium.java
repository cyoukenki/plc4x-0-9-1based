...
public class INTTypeMedium extends DataStruct3 implements Message {
    ...
    public INTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof INTTypeMedium)) {
            return false;
        }
        INTTypeMedium that = (INTTypeMedium) o;
        return
