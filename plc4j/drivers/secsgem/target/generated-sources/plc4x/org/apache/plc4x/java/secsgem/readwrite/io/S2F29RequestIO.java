...
public class S2F29RequestIO implements MessageIO<S2F29Request, S2F29Request> {

    private static final Logger LOGGER = LoggerFactory.getLogger(S2F29RequestIO.class);

    @Override
    public S2F29Request parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S2F29Request) new SecsPacketIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S2F29Request value, Object... args) throws ParseException {
        new SecsPacketIO().serialize(writeBuffer, value, args);
    }

    public static S2F29RequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        readBuffer.pullContext("S2F29Request");
...
values[curItem] = DataStructIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("S2F29Request");
        // Create the instance
        return new S2F29RequestBuilder(symbolTypeDS, values);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, S2F29Request _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("S2F29Request");
        ...
        writeBuffer.popContext("S2F29Request");
    }

    public static class S2F29RequestBuilder implements SecsPacketIO.SecsPacketBuilder {
        private final DataStruct2 symbolTypeDS;
        private final DataStruct[] values;

        public S2F29RequestBuilder(DataStruct2 symbolTypeDS, DataStruct[] values) {
            this.symbolTypeDS = symbolTypeDS;
            this.values = values;
        }

        public S2F29Request build(int deviceID, short PType, short Stype, long systemBytes) {
            return new S2F29Request(deviceID, PType, Stype, systemBytes, symbolTypeDS, values);
        }
    }
