...
public class S1F4Response extends SecsPacket implements Message {
    ...
    public S1F4Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, DataStruct[] values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S1F4Response)) {
            return false;
        }
        S1F4Response that = (S1F4Response) o;
        return
