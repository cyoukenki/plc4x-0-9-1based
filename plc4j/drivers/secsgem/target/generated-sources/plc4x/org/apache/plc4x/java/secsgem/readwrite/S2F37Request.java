...
public class S2F37Request extends SecsPacket implements Message {
    ...
    public S2F37Request(int deviceID, short PType, short Stype, long systemBytes, DataStruct CEED, DataStruct2 symbolTypeDS, DataStruct[] values) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        S2F37Request _value  = this;

        // Const Field (list2)
        lengthInBits += 16;

        // Simple field (CEED)
        lengthInBits += CEED.getLengthInBits();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S2F37Request)) {
            return false;
        }
        S2F37Request that = (S2F37Request) o;
        return
            (getCEED() == that.getCEED()) &&
