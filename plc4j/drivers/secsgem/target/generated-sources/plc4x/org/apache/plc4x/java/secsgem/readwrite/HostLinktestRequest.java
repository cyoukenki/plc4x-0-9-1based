...
public class HostLinktestRequest extends SecsPacket implements Message {
    ...
    public HostLinktestRequest(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        HostLinktestRequest _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostLinktestRequest)) {
            return false;
        }
        HostLinktestRequest that = (HostLinktestRequest) o;
        return
            super.equals(that) &&
            true;
    }
