...
public class DINTTypeMedium extends DataStruct3 implements Message {
    ...
    public DINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DINTTypeMedium)) {
            return false;
        }
        DINTTypeMedium that = (DINTTypeMedium) o;
        return
