...
public class S2F42Response extends SecsPacket implements Message {
    ...
    public S2F42Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct hcack, DataStruct2 symbolTypeDS, ParametersData[] values) {
    ...
    public ParametersData[] getValues() {
        return values;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        S2F42Response _value  = this;

        // Const Field (list2)
        lengthInBits += 16;

        // Simple field (hcack)
        lengthInBits += hcack.getLengthInBits();
        ...
        if(values != null) {
            int i=0;
            for(ParametersData element : values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S2F42Response)) {
            return false;
        }
        S2F42Response that = (S2F42Response) o;
        return
            (getHcack() == that.getHcack()) &&
