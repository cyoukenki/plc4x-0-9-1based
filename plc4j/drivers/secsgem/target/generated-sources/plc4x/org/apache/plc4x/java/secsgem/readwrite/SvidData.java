...
public class SvidData implements Message {


    // Properties.
    private final DataStruct svid;

    public SvidData(DataStruct svid) {
        this.svid = svid;
    }
    ...
    @Override
    public MessageIO<SvidData, SvidData> getMessageIO() {
        return new SvidDataIO();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SvidData)) {
            return false;
        }
        SvidData that = (SvidData) o;
        return
