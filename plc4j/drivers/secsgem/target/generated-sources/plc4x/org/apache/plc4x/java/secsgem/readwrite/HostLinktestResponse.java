...
public class HostLinktestResponse extends SecsPacket implements Message {
    ...
    public HostLinktestResponse(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        HostLinktestResponse _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostLinktestResponse)) {
            return false;
        }
        HostLinktestResponse that = (HostLinktestResponse) o;
        return
            super.equals(that) &&
            true;
    }
