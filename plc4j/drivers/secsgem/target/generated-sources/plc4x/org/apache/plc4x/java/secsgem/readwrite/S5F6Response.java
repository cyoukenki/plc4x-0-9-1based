...
public class S5F6Response extends SecsPacket implements Message {
    ...
    public S5F6Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, AlarmStruct[] values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S5F6Response)) {
            return false;
        }
        S5F6Response that = (S5F6Response) o;
        return
