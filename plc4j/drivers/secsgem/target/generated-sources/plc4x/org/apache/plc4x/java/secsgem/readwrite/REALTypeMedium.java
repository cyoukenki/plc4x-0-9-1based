...
public class REALTypeMedium extends DataStruct3 implements Message {
    ...
    public REALTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof REALTypeMedium)) {
            return false;
        }
        REALTypeMedium that = (REALTypeMedium) o;
        return
