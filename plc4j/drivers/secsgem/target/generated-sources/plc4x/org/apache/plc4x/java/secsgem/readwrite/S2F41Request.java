...
public class S2F41Request extends SecsPacket implements Message {
    ...
    public S2F41Request(int deviceID, short PType, short Stype, long systemBytes, DataStruct rcmd, DataStruct2 symbolTypeDS, ParametersData[] values) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        S2F41Request _value  = this;

        // Const Field (list2)
        lengthInBits += 16;

        // Simple field (rcmd)
        lengthInBits += rcmd.getLengthInBits();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S2F41Request)) {
            return false;
        }
        S2F41Request that = (S2F41Request) o;
        return
            (getRcmd() == that.getRcmd()) &&
