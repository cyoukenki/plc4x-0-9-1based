...
public class UDINTTypeMedium extends DataStruct3 implements Message {
    ...
    public UDINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UDINTTypeMedium)) {
            return false;
        }
        UDINTTypeMedium that = (UDINTTypeMedium) o;
        return
