...
public class CEIDListDataStruct implements Message {
    ...
    public CEIDListDataStruct(DataStruct CEID, DataStruct2 symbolTypeDS, DataStruct[] values) {
        this.CEID = CEID;
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        int lengthInBits = 0;
        CEIDListDataStruct _value  = this;
    ...
    @Override
    public MessageIO<CEIDListDataStruct, CEIDListDataStruct> getMessageIO() {
        return new CEIDListDataStructIO();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CEIDListDataStruct)) {
            return false;
        }
        CEIDListDataStruct that = (CEIDListDataStruct) o;
        return
