...
public class S5F8Response extends SecsPacket implements Message {
    ...
    public S5F8Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, AlarmStruct[] values) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(values != null) {
            int i=0;
            for(AlarmStruct element : values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S5F8Response)) {
            return false;
        }
        S5F8Response that = (S5F8Response) o;
        return
