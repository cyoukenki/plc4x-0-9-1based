...
public class SINTTypeMedium extends DataStruct3 implements Message {
    ...
    public SINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SINTTypeMedium)) {
            return false;
        }
        SINTTypeMedium that = (SINTTypeMedium) o;
        return
