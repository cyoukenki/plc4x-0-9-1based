...
public class S1F3Request extends SecsPacket implements Message {
    ...
    public S1F3Request(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, DataStruct[] values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S1F3Request)) {
            return false;
        }
        S1F3Request that = (S1F3Request) o;
        return
