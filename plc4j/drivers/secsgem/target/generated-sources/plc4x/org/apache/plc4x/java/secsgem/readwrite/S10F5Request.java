...
public class S10F5Request extends SecsPacket implements Message {
    ...
    public S10F5Request(int deviceID, short PType, short Stype, long systemBytes, DataStruct TID, DataStruct2 symbolTypeDS, DataStruct[] values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S10F5Request)) {
            return false;
        }
        S10F5Request that = (S10F5Request) o;
        return
            (getTID() == that.getTID()) &&
