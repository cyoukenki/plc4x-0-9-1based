...
public class EqDeselectResponse extends SecsPacket implements Message {
    ...
    public EqDeselectResponse(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        EqDeselectResponse _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EqDeselectResponse)) {
            return false;
        }
        EqDeselectResponse that = (EqDeselectResponse) o;
        return
            super.equals(that) &&
            true;
    }
