...
public class S1F12Response extends SecsPacket implements Message {
    ...
    public S1F12Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, SVIDDataStruct[] values) {
    ...
    public SVIDDataStruct[] getValues() {
        return values;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(values != null) {
            int i=0;
            for(SVIDDataStruct element : values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S1F12Response)) {
            return false;
        }
        S1F12Response that = (S1F12Response) o;
        return
