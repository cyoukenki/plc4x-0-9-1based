...
public class DataMedium extends DataStruct2 implements Message {
    ...
    public DataMedium(short symbolType, int elementNb) {
        super(symbolType);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataMedium)) {
            return false;
        }
        DataMedium that = (DataMedium) o;
        return
