...
public class ProcessDataStruct implements Message {
    ...
    // Properties.
    private final DataStruct CCODE;
    private final DataStruct2 symbolTypeDS;
    private final DataStruct[] values;

    public ProcessDataStruct(DataStruct CCODE, DataStruct2 symbolTypeDS, DataStruct[] values) {
        this.CCODE = CCODE;
        this.symbolTypeDS = symbolTypeDS;
        this.values = values;
    }

    public DataStruct getCCODE() {
        return CCODE;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        int lengthInBits = 0;
        ProcessDataStruct _value  = this;

        // Const Field (L2)
        lengthInBits += 16;

        // Simple field (CCODE)
        lengthInBits += CCODE.getLengthInBits();
    ...
    @Override
    public MessageIO<ProcessDataStruct, ProcessDataStruct> getMessageIO() {
        return new ProcessDataStructIO();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProcessDataStruct)) {
            return false;
        }
        ProcessDataStruct that = (ProcessDataStruct) o;
        return
            (getCCODE() == that.getCCODE()) &&
