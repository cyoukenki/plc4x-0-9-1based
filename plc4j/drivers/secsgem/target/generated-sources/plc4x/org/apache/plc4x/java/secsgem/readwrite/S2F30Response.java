...
public class S2F30Response extends SecsPacket implements Message {
    ...
    public S2F30Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, ECID2DataStruct[] values) {
    ...
    public ECID2DataStruct[] getValues() {
        return values;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(values != null) {
            int i=0;
            for(ECID2DataStruct element : values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S2F30Response)) {
            return false;
        }
        S2F30Response that = (S2F30Response) o;
        return
