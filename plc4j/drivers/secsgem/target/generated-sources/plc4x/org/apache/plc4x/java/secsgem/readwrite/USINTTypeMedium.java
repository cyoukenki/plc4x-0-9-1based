...
public class USINTTypeMedium extends DataStruct3 implements Message {
    ...
    public USINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof USINTTypeMedium)) {
            return false;
        }
        USINTTypeMedium that = (USINTTypeMedium) o;
        return
