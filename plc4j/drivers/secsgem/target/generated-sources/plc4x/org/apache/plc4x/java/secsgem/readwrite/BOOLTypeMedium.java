...
public class BOOLTypeMedium extends DataStruct3 implements Message {
    ...
    public BOOLTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BOOLTypeMedium)) {
            return false;
        }
        BOOLTypeMedium that = (BOOLTypeMedium) o;
        return
