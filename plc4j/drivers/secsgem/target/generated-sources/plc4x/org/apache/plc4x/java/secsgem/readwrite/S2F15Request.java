...
public class S2F15Request extends SecsPacket implements Message {
    ...
    public S2F15Request(int deviceID, short PType, short Stype, long systemBytes, DataStruct2 symbolTypeDS, ECID1DataStruct[] values) {
    ...
    public ECID1DataStruct[] getValues() {
        return values;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(values != null) {
            int i=0;
            for(ECID1DataStruct element : values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S2F15Request)) {
            return false;
        }
        S2F15Request that = (S2F15Request) o;
        return
