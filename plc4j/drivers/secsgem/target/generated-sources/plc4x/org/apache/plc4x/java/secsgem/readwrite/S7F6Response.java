...
public class S7F6Response extends SecsPacket implements Message {
    ...
    public S7F6Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct PPID, DataStruct3 symbolTypeDS, byte[] data) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S7F6Response)) {
            return false;
        }
        S7F6Response that = (S7F6Response) o;
        return
