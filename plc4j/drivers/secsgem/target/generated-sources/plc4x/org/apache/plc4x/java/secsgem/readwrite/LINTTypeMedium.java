...
public class LINTTypeMedium extends DataStruct3 implements Message {
    ...
    public LINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LINTTypeMedium)) {
            return false;
        }
        LINTTypeMedium that = (LINTTypeMedium) o;
        return
