...
public class HostDeselectResponse extends SecsPacket implements Message {
    ...
    public HostDeselectResponse(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        HostDeselectResponse _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostDeselectResponse)) {
            return false;
        }
        HostDeselectResponse that = (HostDeselectResponse) o;
        return
            super.equals(that) &&
            true;
    }
