...
public class UINTTypeMedium extends DataStruct3 implements Message {
    ...
    public UINTTypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UINTTypeMedium)) {
            return false;
        }
        UINTTypeMedium that = (UINTTypeMedium) o;
        return
