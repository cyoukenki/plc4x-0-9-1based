...
public class S6F16Response extends SecsPacket implements Message {
    ...
    // Constant values.
    public static final int LIST3 = 0x0103;
    ...
    public S6F16Response(int deviceID, short PType, short Stype, long systemBytes, DataStruct dataId, DataStruct ceId, DataStruct2 symbolTypeDS, RPTIDListDataStruct[] values) {
    ...
    public RPTIDListDataStruct[] getValues() {
        return values;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        if(values != null) {
            int i=0;
            for(RPTIDListDataStruct element : values) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S6F16Response)) {
            return false;
        }
        S6F16Response that = (S6F16Response) o;
        return
