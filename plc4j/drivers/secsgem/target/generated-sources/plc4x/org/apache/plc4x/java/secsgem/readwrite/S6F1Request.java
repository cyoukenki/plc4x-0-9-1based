...
public class S6F1Request extends SecsPacket implements Message {
    ...
    // Constant values.
    public static final int LIST4 = 0x0104;
    ...
    public S6F1Request(int deviceID, short PType, short Stype, long systemBytes, DataStruct trid, DataStruct smpln, DataStruct stime, DataStruct2 symbolTypeDS, DataStruct[] values) {
    ...
    public DataStruct getSmpln() {
        return smpln;
    }

    public DataStruct getStime() {
        return stime;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        // Simple field (smpln)
        lengthInBits += smpln.getLengthInBits();

        // Simple field (stime)
        lengthInBits += stime.getLengthInBits();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof S6F1Request)) {
            return false;
        }
        S6F1Request that = (S6F1Request) o;
        return
            (getTrid() == that.getTrid()) &&
            (getSmpln() == that.getSmpln()) &&
            (getStime() == that.getStime()) &&
