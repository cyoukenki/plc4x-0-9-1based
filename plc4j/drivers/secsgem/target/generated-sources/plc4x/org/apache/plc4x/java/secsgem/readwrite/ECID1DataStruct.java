...
public class ECID1DataStruct implements Message {
    ...
    public ECID1DataStruct(DataStruct2 symbolTypeDS, DataStruct[] values) {
    ...
    @Override
    public MessageIO<ECID1DataStruct, ECID1DataStruct> getMessageIO() {
        return new ECID1DataStructIO();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ECID1DataStruct)) {
            return false;
        }
        ECID1DataStruct that = (ECID1DataStruct) o;
        return
