...
public class BYTETypeMedium extends DataStruct3 implements Message {
    ...
    public BYTETypeMedium(short symbolType1, int elementNb) {
        super(symbolType1);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BYTETypeMedium)) {
            return false;
        }
        BYTETypeMedium that = (BYTETypeMedium) o;
        return
