...
public class HostSeparateRepuest extends SecsPacket implements Message {
    ...
    public HostSeparateRepuest(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        HostSeparateRepuest _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostSeparateRepuest)) {
            return false;
        }
        HostSeparateRepuest that = (HostSeparateRepuest) o;
        return
            super.equals(that) &&
            true;
    }
