...
public class EqLinktestResponse extends SecsPacket implements Message {
    ...
    public EqLinktestResponse(int deviceID, short PType, short Stype, long systemBytes) {
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        EqLinktestResponse _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EqLinktestResponse)) {
            return false;
        }
        EqLinktestResponse that = (EqLinktestResponse) o;
        return
            super.equals(that) &&
            true;
    }
