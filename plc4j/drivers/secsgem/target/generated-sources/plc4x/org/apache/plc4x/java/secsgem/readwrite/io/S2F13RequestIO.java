...
public class S2F13RequestIO implements MessageIO<S2F13Request, S2F13Request> {

    private static final Logger LOGGER = LoggerFactory.getLogger(S2F13RequestIO.class);

    @Override
    public S2F13Request parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (S2F13Request) new SecsPacketIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, S2F13Request value, Object... args) throws ParseException {
        new SecsPacketIO().serialize(writeBuffer, value, args);
    }

    public static S2F13RequestBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
        readBuffer.pullContext("S2F13Request");
...
values[curItem] = DataStructIO.staticParse(readBuffer ) ;            }
        ...
        readBuffer.closeContext("S2F13Request");
        // Create the instance
        return new S2F13RequestBuilder(symbolTypeDS, values);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, S2F13Request _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("S2F13Request");
        ...
        writeBuffer.popContext("S2F13Request");
    }

    public static class S2F13RequestBuilder implements SecsPacketIO.SecsPacketBuilder {
        private final DataStruct2 symbolTypeDS;
        private final DataStruct[] values;

        public S2F13RequestBuilder(DataStruct2 symbolTypeDS, DataStruct[] values) {
            this.symbolTypeDS = symbolTypeDS;
            this.values = values;
        }

        public S2F13Request build(int deviceID, short PType, short Stype, long systemBytes) {
            return new S2F13Request(deviceID, PType, Stype, systemBytes, symbolTypeDS, values);
        }
    }
