...
public class SysexCommandCapabilityResponseIO implements MessageIO<SysexCommandCapabilityResponse, SysexCommandCapabilityResponse> {
    ...
    @Override
    public SysexCommandCapabilityResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SysexCommandCapabilityResponse) new SysexCommandIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SysexCommandCapabilityResponse value, Object... args) throws ParseException {
        new SysexCommandIO().serialize(writeBuffer, value, args);
    }

    public static SysexCommandCapabilityResponseBuilder staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, SysexCommandCapabilityResponse _value) throws ParseException {
