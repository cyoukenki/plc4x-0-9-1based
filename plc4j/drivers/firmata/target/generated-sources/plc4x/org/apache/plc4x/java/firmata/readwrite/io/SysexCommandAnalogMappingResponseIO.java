...
public class SysexCommandAnalogMappingResponseIO implements MessageIO<SysexCommandAnalogMappingResponse, SysexCommandAnalogMappingResponse> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SysexCommandAnalogMappingResponseIO.class);

    @Override
    public SysexCommandAnalogMappingResponse parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SysexCommandAnalogMappingResponse) new SysexCommandIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SysexCommandAnalogMappingResponse value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, SysexCommandAnalogMappingResponse _value) throws ParseException {
        int startPos = writeBuffer.getPos();
        writeBuffer.pushContext("SysexCommandAnalogMappingResponse");
        writeBuffer.popContext("SysexCommandAnalogMappingResponse");
    }
