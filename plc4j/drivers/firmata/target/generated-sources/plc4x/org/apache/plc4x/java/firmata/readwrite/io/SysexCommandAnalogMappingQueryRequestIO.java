...
public class SysexCommandAnalogMappingQueryRequestIO implements MessageIO<SysexCommandAnalogMappingQueryRequest, SysexCommandAnalogMappingQueryRequest> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SysexCommandAnalogMappingQueryRequestIO.class);

    @Override
    public SysexCommandAnalogMappingQueryRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SysexCommandAnalogMappingQueryRequest) new SysexCommandIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SysexCommandAnalogMappingQueryRequest value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, SysexCommandAnalogMappingQueryRequest _value) throws ParseException {
