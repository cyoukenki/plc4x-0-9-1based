...
public class SysexCommandExendedId extends SysexCommand implements Message {
    ...
    public SysexCommandExendedId(byte[] id) {
        this.id = id;
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        SysexCommandExendedId _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SysexCommandExendedId)) {
            return false;
        }
        SysexCommandExendedId that = (SysexCommandExendedId) o;
        return
            (getId() == that.getId()) &&
            super.equals(that) &&
            true;
