...
public class SysexCommandPinStateQueryIO implements MessageIO<SysexCommandPinStateQuery, SysexCommandPinStateQuery> {
    ...
    @Override
    public SysexCommandPinStateQuery parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (SysexCommandPinStateQuery) new SysexCommandIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, SysexCommandPinStateQuery value, Object... args) throws ParseException {
...
short pin = readBuffer.readUnsignedShort("pin", 8) ;
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, SysexCommandPinStateQuery _value) throws ParseException {
