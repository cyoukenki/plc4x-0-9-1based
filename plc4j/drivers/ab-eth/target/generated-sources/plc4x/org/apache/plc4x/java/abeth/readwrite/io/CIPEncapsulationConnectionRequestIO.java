...
public class CIPEncapsulationConnectionRequestIO implements MessageIO<CIPEncapsulationConnectionRequest, CIPEncapsulationConnectionRequest> {
    ...
    @Override
    public CIPEncapsulationConnectionRequest parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (CIPEncapsulationConnectionRequest) new CIPEncapsulationPacketIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, CIPEncapsulationConnectionRequest value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, CIPEncapsulationConnectionRequest _value) throws ParseException {
    ...
    public static class CIPEncapsulationConnectionRequestBuilder implements CIPEncapsulationPacketIO.CIPEncapsulationPacketBuilder {
        ...
        public CIPEncapsulationConnectionRequest build(long sessionHandle, long status, short[] senderContext, long options) {
