...
public class DceRpc_Packet_Req extends DceRpc_Packet implements Message {
    ...
    public static final byte IDEMPOTENT = 1;
    ...
    public DceRpc_Packet_Req(int instanceOrNodeNumber, int deviceId, int vendorId, long activity, long serverBootTime, long sequenceNumber, DceRpc_Operation operation, PnIoCm_Packet payload) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DceRpc_Packet_Req)) {
            return false;
        }
        DceRpc_Packet_Req that = (DceRpc_Packet_Req) o;
        return
            super.equals(that) &&
            true;
    }
