...
public class PnDcp_Pdu_GetReq extends PnDcp_Pdu implements Message {
    ...
    public PnDcp_Pdu_GetReq(PnDcp_ServiceType serviceType, long xid, int responseDelayFactorOrPadding) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PnDcp_Pdu_GetReq)) {
            return false;
        }
        PnDcp_Pdu_GetReq that = (PnDcp_Pdu_GetReq) o;
        return
            super.equals(that) &&
            true;
    }
