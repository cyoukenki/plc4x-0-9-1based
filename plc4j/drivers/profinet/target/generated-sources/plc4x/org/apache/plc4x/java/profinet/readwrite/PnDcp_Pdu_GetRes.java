...
public class PnDcp_Pdu_GetRes extends PnDcp_Pdu implements Message {
    ...
    public PnDcp_Pdu_GetRes(PnDcp_ServiceType serviceType, long xid, int responseDelayFactorOrPadding) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PnDcp_Pdu_GetRes)) {
            return false;
        }
        PnDcp_Pdu_GetRes that = (PnDcp_Pdu_GetRes) o;
        return
            super.equals(that) &&
            true;
    }
