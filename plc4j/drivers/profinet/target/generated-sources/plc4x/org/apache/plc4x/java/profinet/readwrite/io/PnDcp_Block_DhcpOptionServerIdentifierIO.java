...
public class PnDcp_Block_DhcpOptionServerIdentifierIO implements MessageIO<PnDcp_Block_DhcpOptionServerIdentifier, PnDcp_Block_DhcpOptionServerIdentifier> {
    ...
    @Override
    public PnDcp_Block_DhcpOptionServerIdentifier parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (PnDcp_Block_DhcpOptionServerIdentifier) new PnDcp_BlockIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, PnDcp_Block_DhcpOptionServerIdentifier value, Object... args) throws ParseException {
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, PnDcp_Block_DhcpOptionServerIdentifier _value) throws ParseException {
