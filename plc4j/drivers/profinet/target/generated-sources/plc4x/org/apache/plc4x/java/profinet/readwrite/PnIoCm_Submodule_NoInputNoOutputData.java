...
public class PnIoCm_Submodule_NoInputNoOutputData extends PnIoCm_Submodule implements Message {
    ...
    // Constant values.
    public static final int DATADESCRIPTION = 0x0001;
    public static final int SUBMODULEDATALENGTH = 0x0000;
    public static final short LENGTHIOCS = 0x01;
    public static final short LENGTHIOPS = 0x01;

    public PnIoCm_Submodule_NoInputNoOutputData(int slotNumber, long submoduleIdentNumber, boolean discardIoxs, boolean reduceOutputModuleDataLength, boolean reduceInputModuleDataLength, boolean sharedInput) {
