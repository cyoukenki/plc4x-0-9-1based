...
public class PnDcp_Pdu_IdentifyResIO implements MessageIO<PnDcp_Pdu_IdentifyRes, PnDcp_Pdu_IdentifyRes> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PnDcp_Pdu_IdentifyResIO.class);

    @Override
    public PnDcp_Pdu_IdentifyRes parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return (PnDcp_Pdu_IdentifyRes) new PnDcp_PduIO().parse(readBuffer, args);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, PnDcp_Pdu_IdentifyRes value, Object... args) throws ParseException {
        new PnDcp_PduIO().serialize(writeBuffer, value, args);
    }

    public static PnDcp_Pdu_IdentifyResBuilder staticParse(ReadBuffer readBuffer, Integer dcpDataLength) throws ParseException {
        ...
        // Create the instance
        return new PnDcp_Pdu_IdentifyResBuilder(blocks);
    }

    public static void staticSerialize(WriteBuffer writeBuffer, PnDcp_Pdu_IdentifyRes _value) throws ParseException {
    ...
    public static class PnDcp_Pdu_IdentifyResBuilder implements PnDcp_PduIO.PnDcp_PduBuilder {
        private final PnDcp_Block[] blocks;

        public PnDcp_Pdu_IdentifyResBuilder(PnDcp_Block[] blocks) {
            this.blocks = blocks;
        }

        public PnDcp_Pdu_IdentifyRes build(PnDcp_ServiceType serviceType, long xid, int responseDelayFactorOrPadding) {
            return new PnDcp_Pdu_IdentifyRes(serviceType, xid, responseDelayFactorOrPadding, blocks);
        }
    }
