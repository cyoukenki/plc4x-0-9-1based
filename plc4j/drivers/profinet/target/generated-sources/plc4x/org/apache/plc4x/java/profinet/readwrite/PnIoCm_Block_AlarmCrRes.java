...
public class PnIoCm_Block_AlarmCrRes extends PnIoCm_Block implements Message {
    ...
    public PnIoCm_Block_AlarmCrRes(short blockVersionHigh, short blockVersionLow, PnIoCm_AlarmCrType alarmType, int localAlarmReference, int maxAlarmDataLength) {
