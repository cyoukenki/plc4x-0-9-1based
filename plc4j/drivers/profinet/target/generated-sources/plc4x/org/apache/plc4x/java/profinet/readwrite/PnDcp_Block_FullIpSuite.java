...
public class PnDcp_Block_FullIpSuite extends PnDcp_Block implements Message {
    ...
    public PnDcp_Block_FullIpSuite() {
    }
    ...
    public int getLengthInBitsConditional(boolean lastItem) {
        ...
        PnDcp_Block_FullIpSuite _value  = this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PnDcp_Block_FullIpSuite)) {
            return false;
        }
        PnDcp_Block_FullIpSuite that = (PnDcp_Block_FullIpSuite) o;
        return
            super.equals(that) &&
            true;
    }
