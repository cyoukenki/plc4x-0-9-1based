...
public class IpAddressIO implements MessageIO<IpAddress, IpAddress> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(IpAddressIO.class);

    @Override
    public IpAddress parse(ReadBuffer readBuffer, Object... args) throws ParseException {
        return IpAddressIO.staticParse(readBuffer);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer, IpAddress value, Object... args) throws ParseException {
        IpAddressIO.staticSerialize(writeBuffer, value);
    }
    ...
    public static void staticSerialize(WriteBuffer writeBuffer, IpAddress _value) throws ParseException {
