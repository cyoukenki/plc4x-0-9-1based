...
public interface ProtocolStackConfigurer<T extends Message> {
    ...
    Plc4xProtocolBase<?> configureServerPipeline(Configuration configuration, ChannelPipeline pipeline, boolean b, DefaultServerConnectorListener connectorListener);
}
