...
public class DefaultNettyPlcSerialServerConnector extends AbstractPlcServerConnector implements ChannelExposingConnection, EventPlcConnection {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DefaultNettyPlcSerialServerConnector.class);
    ...
    public DefaultNettyPlcSerialServerConnector(boolean canRead, boolean canWrite, boolean canSubscribe,
...
//        channel.close().awaitUninterruptibly();
    ...
    public PlcField prepareField(String fieldQuery) throws PlcInvalidFieldException {
        return super.prepareField(fieldQuery);
    }
    ...
    public ChannelHandler getChannelHandler(CompletableFuture<Void> sessionSetupCompleteFuture, CompletableFuture<Void> sessionDisconnectCompleteFuture, CompletableFuture<Configuration> sessionDiscoverCompleteFuture) {
        ...
        return new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel channel) {
                ...
                setProtocol(stackConfigurer.configureServerPipeline(configuration, pipeline, channelFactory.isPassive(),connectorListener));
            }
        };
    }
