 ...
 */
public abstract class AbstractPlcServerConnector implements PlcServerConnector, PlcConnectionMetadata, PlcReader, PlcWriter , PlcSubscriber {
     ...
     */
    @Deprecated
    protected AbstractPlcServerConnector() {
    }

    protected AbstractPlcServerConnector(boolean canRead, boolean canWrite, boolean canSubscribe, PlcFieldHandler fieldHandler, PlcValueHandler valueHandler,
