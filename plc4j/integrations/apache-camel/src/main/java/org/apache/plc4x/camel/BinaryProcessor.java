...
public class BinaryProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (exchange.getIn().getBody() instanceof byte[]) {
            ...
            LOGGER.info("receive binary byte[] is {}", list.toString());
        }
        ...
        List<Map<String, Object>> maps = DataSpliter.combineMapInOrder(dataMap);
        String jsonResult = new Gson().toJson(maps);
