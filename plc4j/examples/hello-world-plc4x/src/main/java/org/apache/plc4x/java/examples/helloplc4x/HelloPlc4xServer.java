...
import org.apache.plc4x.java.api.PlcConnectorFuture;
...
public class HelloPlc4xServer {

    private static final Logger logger = LoggerFactory.getLogger(HelloPlc4xServer.class);
    ...
    public static void main(String[] args) throws Exception {
        PlcServerConnector serverConnector = new PlcDriverManager().getServerConnector("secsgem:tcp://192.168.31.83:44818");
    }
